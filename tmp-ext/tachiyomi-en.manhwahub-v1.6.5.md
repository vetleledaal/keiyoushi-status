...
- Extension: tachiyomi-en.manhwahub-v1.6.5
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: manhwahub.net
...
- Source ID: 1620136505388614489
- Source name: ManhwaHub
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: manhwahub.net: No address associated with hostname | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: manhwahub.net | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: manhwahub.net: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manhwahub.net |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: manhwahub.net | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manhwahub.net |
...
| popular listing | SKIP | manhwahub.net: No address associated with hostname |  |  |  |
| latest listing | SKIP | manhwahub.net |  |  |  |
...
| popular pagination | SKIP | manhwahub.net: No address associated with hostname |  |  |  |
| latest pagination | SKIP | manhwahub.net |  |  |  |
