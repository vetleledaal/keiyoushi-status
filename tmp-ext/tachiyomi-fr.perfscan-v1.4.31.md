...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | javax.net.ssl.SSLHandshakeException: (unrecognized_name) Received fatal alert: unrecognized_name | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | javax.net.ssl.SSLHandshakeException: (unrecognized_name) Received fatal alert: unrecognized_name | <1s |
