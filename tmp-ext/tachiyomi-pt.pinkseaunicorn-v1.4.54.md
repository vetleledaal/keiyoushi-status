...
- Extension: tachiyomi-pt.pinkseaunicorn-v1.4.54
- Input artifact: JAR
...
- Source ID: 2541069900188080676
- Source name: Pink Sea Unicorn
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: Autentique-se através da WebView e tente novamente. | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.io.IOException: Autentique-se através da WebView e tente novamente. | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Autentique-se através da WebView e tente novamente. | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: Autentique-se através da WebView e tente novamente. | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Autentique-se através da WebView e tente novamente. |  |  |  |
| latest listing | SKIP | Autentique-se através da WebView e tente novamente. |  |  |  |
...
| popular pagination | SKIP | Autentique-se através da WebView e tente novamente. |  |  |  |
| latest pagination | SKIP | Autentique-se através da WebView e tente novamente. |  |  |  |
