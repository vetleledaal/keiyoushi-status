...
- Extension: tachiyomi-es.neomanga-v1.4.1
- Input artifact: JAR
...
- Source ID: 4960725964791825687
- Source name: NeoManga
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 402 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 402 | REVIEW | INSUFFICIENT_EVIDENCE |  |
