...
- Extension: tachiyomi-en.mangakiss-v1.6.55
- Input artifact: JAR
...
- Source ID: 2402699562771779060
- Source name: Manga Kiss
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 522 | 10s+ |
