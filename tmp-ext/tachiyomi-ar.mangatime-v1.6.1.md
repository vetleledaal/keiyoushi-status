...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 24 | بلو لوك (`.../blue-lock`) |  | <1s |
| popular_next | `getPopularManga(2)` | success | 24 | سولو ليفلينج: راغناروك (`.../solo-leveling-ragnarok`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 24 | Hand Jumper (`.../hand-jumper`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 24 | أرض الضباب (`.../fog-land`) |  | <1s |
| search | `getSearchManga(1, query, getFilterList())` | success | 5 | بلو لوك (`.../blue-lock`) |  | <1s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | بلو لوك (`.../blue-lock`) |  | <1s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 363 | Chapter - 1 (`.../1`) |  | <1s |
