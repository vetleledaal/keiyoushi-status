...
- Extension: tachiyomi-tr.summertoon-v1.4.54
- Input artifact: JAR
...
- Source ID: 1346985078461508977
- Source name: SummerToon
- Source language: tr
...
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 400 | <1s |
