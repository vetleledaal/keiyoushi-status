...
- Extension: tachiyomi-pt.manganyx-v1.6.3
- Input artifact: JAR
...
- Source theme: aurora
- Source ID: 5545056451990986567
- Source name: Manga NXY
...
| redirects | UNUSUAL | popular: `https://manganyx.com/.../catalogo` to `https://manganyx.org/.../catalogo` (1 redirects); popular: `https://manganyx.com/.../novidades` to `https://manganyx.org/.../novidades` (1 redirects) |  |  |  |
