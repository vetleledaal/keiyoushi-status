...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 30 | "Nobukuni-San" Does She Likes Me? (`.../200170`) |  | 1-10s |
| popular_next | `fetchPopularManga(2)` | success | 30 | Burial Sword Art (`.../202342`) |  | 1-10s |
| latest | `fetchLatestUpdates(1)` | success | 43 | The S-Classes That I Raised (`.../207906`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | skipped | 0 |  |  | <1s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 9 | "Nobukuni-San" Does She Likes Me? (`.../200170`) |  | <1s |
