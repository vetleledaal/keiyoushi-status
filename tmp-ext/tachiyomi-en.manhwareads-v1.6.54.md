...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 184 | Chapter 001 (`.../chapter-001`) |  | <1s |
...
| chapters | PASS | 184 chapters |  |  |  |
| chapter dates | LINT | 17 of 184 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=17 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
