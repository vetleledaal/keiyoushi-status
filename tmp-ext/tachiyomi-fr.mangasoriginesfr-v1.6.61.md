...
- Extension: tachiyomi-fr.mangasoriginesfr-v1.6.61
- Input artifact: JAR
...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 30 | Solo Leveling (`.../826-solo-leveling`) |  | 1-10s |
...
| latest | `getLatestUpdates(1)` | success | 30 | Demonic Emperor (`.../magic-emperor`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 30 | Death Penalty (`.../death-penalty`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 12 | F-Class Destiny Hunter (`.../f-class-destiny-hunter`) |  | 1-10s |
