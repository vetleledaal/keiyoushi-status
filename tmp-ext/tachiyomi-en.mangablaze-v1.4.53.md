...
- Extension: tachiyomi-en.mangablaze-v1.4.53
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: mangablaze.com
...
- Source ID: 6145388266378605164
- Source name: MangaBlaze
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: mangablaze.com | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: mangablaze.com: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: mangablaze.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: mangablaze.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: mangablaze.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: mangablaze.com |
...
| popular listing | SKIP | mangablaze.com |  |  |  |
| latest listing | SKIP | mangablaze.com: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | mangablaze.com |  |  |  |
| latest pagination | SKIP | mangablaze.com: No address associated with hostname |  |  |  |
