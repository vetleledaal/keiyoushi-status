...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 25 | The Yellow-Haired Villain in the Female Main Character’s Novel Wants Happiness (`.../1531`) |  | <1s |
| popular_next | `getPopularManga(2)` | success | 6 | My Wife Is Actually The Demon Cult Leader (`.../2517`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 25 | National Class: Fusion Master — Starting by Synthesizing an Undead Army (`.../2702`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 6 | Forging an Industrial Empire in a Magical World (`.../603`) |  | 10s+ |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 403 | 10s+ |
