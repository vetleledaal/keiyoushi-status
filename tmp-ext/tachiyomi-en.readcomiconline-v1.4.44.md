...
- Extension: tachiyomi-en.readcomiconline-v1.4.44
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: readcomiconline.li
...
- Source name: ReadComicOnline
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: readcomiconline.li | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: readcomiconline.li: No address associated with hostname | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: readcomiconline.li | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: readcomiconline.li |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: readcomiconline.li: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: readcomiconline.li |
...
| popular listing | SKIP | readcomiconline.li |  |  |  |
| latest listing | SKIP | readcomiconline.li: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | readcomiconline.li |  |  |  |
| latest pagination | SKIP | readcomiconline.li: No address associated with hostname |  |  |  |
