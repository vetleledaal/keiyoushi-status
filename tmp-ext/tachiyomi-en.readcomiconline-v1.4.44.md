...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: readcomiconline.li: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: readcomiconline.li | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: readcomiconline.li: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: readcomiconline.li |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: readcomiconline.li | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: readcomiconline.li |
...
| popular listing | SKIP | readcomiconline.li: No address associated with hostname |  |  |  |
| latest listing | SKIP | readcomiconline.li |  |  |  |
...
| popular pagination | SKIP | readcomiconline.li: No address associated with hostname |  |  |  |
| latest pagination | SKIP | readcomiconline.li |  |  |  |
