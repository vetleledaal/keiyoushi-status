...
- Extension: tachiyomi-fr.softepsilonscan-v1.4.55
- Input artifact: JAR
...
- Source ID: 4969929389259348100
- Source name: Soft Epsilon Scan
- Source language: fr

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.Exception: HTTP Error 403 | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.Exception: HTTP Error 403 | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.lang.Exception: HTTP Error 403 | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.lang.Exception: HTTP Error 403 | REVIEW | INSUFFICIENT_EVIDENCE |  |
