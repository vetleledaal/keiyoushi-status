...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 8 | Tensei Coliseum: Saijaku Skill de Saikyou no Onna-tachi o Koryaku Shite Dorei Harem Tsukurimasu (`.../tensei-coliseum-saijaku-skill-de-saikyou-no-onna-tachi-o-koryaku-shite-dorei-harem-tsukurimasu`) |  | <1s |
...
| latest_next | `fetchLatestUpdates(2)` | success | 9 | YOUR TASTE IS A LITTLE SWEET (`.../your-taste-is-a-little-sweet`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 1 | Chap 1 Mon skill est trop nul…? (`.../mon-skill-est-trop-nul`) |  | 10s+ |
| pages | `fetchPageList(chapter)` | success | 59 |  |  | <1s |
...
| redirects | UNUSUAL | popular_next: `https://hentai.scanreader.net/.../1 <redacted query values: sort>` to `https://hentai.scanreader.net/.../bibliotheque <redacted query values: sort>` (1 redirects); latest: `https://hentai.scanreader.net/.../1` to `https://hentai.scanreader.net/.../dernieres-sorties` (1 redirects); chapters: `https://hentai.scanreader.net/.../admin-ajax.php` to `https://hentai.scanreader.net/.../admin-ajax.php` (1 redirects) |  |  |  |
