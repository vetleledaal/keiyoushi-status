...
- Extension: tachiyomi-vi.soaicacomic-v1.6.5
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 32 | Tôi Chỉ Cần Đứa Con Của Công Tước (`.../toi-chi-can-dua-con-cua-cong-tuoc`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 32 | Tiểu Gia Chủ Tám Tuổi Gánh Cả Gia Tộc (`.../tieu-gia-chu-tam-tuoi-ganh-ca-gia-toc`) |  | 1-10s |
...
| page load | PASS | `https://cloud-2.soaicacomic2.top/.../b7dd3c1877406404c71e80454f48485a.jpg` (image/jpeg, 894114 bytes, 900x11799) |  |  |  |
