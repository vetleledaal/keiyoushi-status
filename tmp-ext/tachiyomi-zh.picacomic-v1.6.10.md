...
- Extension: tachiyomi-zh.picacomic-v1.6.10
- Input artifact: JAR
...
- Source ID: 5768337869316468367
- Source name: 哔咔漫画
- Source language: zh

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.io.IOException: 请在扩展设置界面输入用户名和密码 | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.io.IOException: 请在扩展设置界面输入用户名和密码 | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: 请在扩展设置界面输入用户名和密码 | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: 请在扩展设置界面输入用户名和密码 | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | 请在扩展设置界面输入用户名和密码 |  |  |  |
| latest listing | SKIP | 请在扩展设置界面输入用户名和密码 |  |  |  |
...
| popular pagination | SKIP | 请在扩展设置界面输入用户名和密码 |  |  |  |
| latest pagination | SKIP | 请在扩展设置界面输入用户名和密码 |  |  |  |
