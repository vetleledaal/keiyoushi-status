...
| latest | `getLatestUpdates(1)` | success | 30 | Profissão sem Valor: Domador de Dragões (`.../35`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 30 | A batalha através dos céus (`.../254`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | Necromante: Rei dos Mortos (`.../682`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 |  (`.../682`) |  | <1s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 305 | Capítulo 1 (`.../67865`) |  | <1s |
