...
| popular_next | `getPopularManga(2)` | success | 15 | Не жартуй з цуциком! (`.../1597`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 15 | Коли Яси свистить (`.../2072`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 15 | Ірреальне буття  (`.../4111`) |  | <1s |
