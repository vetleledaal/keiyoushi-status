...
| latest | `getLatestUpdates(1)` | success | 25 | Codename Anastasia (`.../252`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Pygmalion (`.../2083`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 113 | Bölüm 1 (`.../bolum-1`) |  | 1-10s |
