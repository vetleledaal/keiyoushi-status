...
- Extension: tachiyomi-en.nixmanga-v1.4.2
- Input artifact: JAR
...
- Source ID: 3470536709327419459
- Source name: NixManga
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.NullPointerException | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.NullPointerException | <1s |
