...
- Extension: tachiyomi-en.skymanga-v1.4.33
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: skymanga.work
...
- Source ID: 3308452263937112975
- Source name: Sky Manga
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: skymanga.work | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: skymanga.work: No address associated with hostname | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: skymanga.work | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: skymanga.work |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: skymanga.work: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: skymanga.work |
...
| popular listing | SKIP | skymanga.work |  |  |  |
| latest listing | SKIP | skymanga.work: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | skymanga.work |  |  |  |
| latest pagination | SKIP | skymanga.work: No address associated with hostname |  |  |  |
