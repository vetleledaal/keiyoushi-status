...
| latest | `getLatestUpdates(1)` | success | 30 | The Retired Saintess Raises Property Values (`.../the-retired-saintess-raises-property-values`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 30 | Once an Assassin, Now a Royal Nanny (`.../once-an-assassin-now-a-royal-nanny`) |  | 1-10s |
...
| latest pagination | UNUSUAL | Overlapping manga: title=Once an Assassin, Now a Royal Nanny, URL=`.../once-an-assassin-now-a-royal-nanny` at page 1 offset 26 and page 2 offset 0, title=Taming the Munchkin, URL=`.../taming-the-munchkin` at page 1 offset 27 and page 2 offset 1, title=Lord Baby Runs A Romance Fantasy With Cash, URL=`.../lord-baby-runs-a-romance-fantasy-with-cash` at page 1 offset 28 and page 2 offset 2, title=No Place for the Fake Princess, URL=`.../no-place-for-the-fake-princess` at page 1 offset 29 and page 2 offset 3 |  |  |  |
| listing duplicates | PASS |  |  |  |  |
| manga title and URL | PASS | 121/121 listing manga have titles and relative URLs |  |  |  |
| thumbnail URLs | UNUSUAL | 119/121 manga have thumbnail URLs |  |  |  |
...
| redirects | UNUSUAL | popular: `https://mangaonline.fun/.../chapter-2809` to `https://mangaonline.fun/.../martial-peak` (1 redirects) |  |  |  |
