...
- Extension: tachiyomi-tr.zenithscans-v1.4.32
- Input artifact: JAR
...
- Source ID: 1669762383546832433
- Source name: Zenith Scans
- Source language: tr
...
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 503 | <1s |
