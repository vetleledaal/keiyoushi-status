...
- Extension: tachiyomi-fr.epsilonscan-v1.4.55
- Input artifact: JAR
...
- Source ID: 2577248042661857530
- Source name: Epsilon Scan
- Source language: fr

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.Exception: HTTP Error 403 | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.Exception: HTTP Error 403 | 1-10s |
