...
- Retry condition: HOST_RESOLVES: utsukushii-bg.com
...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: utsukushii-bg.com | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: utsukushii-bg.com: No address associated with hostname | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: utsukushii-bg.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: utsukushii-bg.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: utsukushii-bg.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: utsukushii-bg.com |
...
| popular listing | SKIP | utsukushii-bg.com |  |  |  |
| latest listing | SKIP | utsukushii-bg.com: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | utsukushii-bg.com |  |  |  |
| latest pagination | SKIP | utsukushii-bg.com: No address associated with hostname |  |  |  |
