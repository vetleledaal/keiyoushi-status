...
- Extension: tachiyomi-all.simplycosplay-v1.4.4
- Input artifact: JAR
...
- Source ID: 5522274089781089670
- Source name: Simply Cosplay
- Source language: all

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.EOFException: SSL peer shut down incorrectly | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.io.EOFException: SSL peer shut down incorrectly | 1-10s |
