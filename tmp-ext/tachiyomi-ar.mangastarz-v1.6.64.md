...
| latest_next | `getLatestUpdates(2)` | success | 25 | crocodile (`.../184869`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | Otherworldly Evil Monarch (`.../775`) |  | 1-10s |
...
| thumbnail | PASS | `https://starz.starzmanga.com/.../Otherworldly-Evil-Monarch-175x238.jpg` (image/jpeg, 15870 bytes, 175x238) |  |  |  |
