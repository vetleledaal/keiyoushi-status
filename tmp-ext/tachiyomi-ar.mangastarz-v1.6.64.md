...
- Extension: tachiyomi-ar.mangastarz-v1.6.64
- Input artifact: JAR
...
- Source ID: 6058166507489091982
- Source name: Manga Starz
- Source language: ar
- Selected manga input: latest offset 0: Unofficial Campus Couple (`.../177568`)
...
| latest_next | `getLatestUpdates(2)` | success | 25 | .Reincarnator’s Stream (`.../165939`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | Unofficial Campus Couple (`.../177568`) |  | 1-10s |
...
| search listing | PASS | Matched selected manga by URL at result offset 0: title=Unofficial Campus Couple, URL=`177568` |  |  |  |
...
| thumbnail | PASS | `https://starz.starzmanga.com/.../images-6-175x238.jpg` (image/jpeg, 13965 bytes, 175x238) |  |  |  |
