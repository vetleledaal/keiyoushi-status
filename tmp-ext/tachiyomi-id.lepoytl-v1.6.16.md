...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 10 | Wolf Falls in Love with Moon (`.../wolf-falls-in-love-with-moon.html`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | success | 20 | Ogami Tsumiki To Kinichijou (`.../ogami-tsumiki-to-kinichijou.html`) |  | 1-10s |
