...
- Extension: tachiyomi-zh.creativecomic-v1.4.2
- Input artifact: JAR
...
- Source ID: 8346821279138091413
- Source name: CCC追漫台
- Source language: zh-Hant

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.NullPointerException | 10s+ |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.NullPointerException | 10s+ |
