...
- Extension: tachiyomi-en.mangareadorg-v1.6.57
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 25 | The Genius Decided to Live an Ordinary Life (`.../264388`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Swept Away to a Reversed World: The Harem Life of a Rare Man Surviving in an Alternate World (`.../340916`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 10 | Martial Peak (`.../2344`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Martial Peak (`.../2344`) |  | <1s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 3864 | Chapter 1 (`.../chapter-1`) |  | 1-10s |
