...
- Extension: tachiyomi-zh.vomic-v1.4.6
- Input artifact: JAR
...
- Source ID: 3329849726908639188
- Source name: vomic
- Source language: zh

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: 请在插件设置中修改网址 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: 请在插件设置中修改网址 | REVIEW | INSUFFICIENT_EVIDENCE |  |
