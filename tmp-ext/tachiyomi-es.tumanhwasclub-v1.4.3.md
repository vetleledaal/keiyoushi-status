...
- Extension: tachiyomi-es.tumanhwasclub-v1.4.3
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: manhwas.me
...
- Source ID: 8004442288770923365
- Source name: ManhwasMe
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: manhwas.me | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: manhwas.me: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: manhwas.me | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manhwas.me |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: manhwas.me: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manhwas.me |
...
| popular listing | SKIP | manhwas.me |  |  |  |
| latest listing | SKIP | manhwas.me: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | manhwas.me |  |  |  |
| latest pagination | SKIP | manhwas.me: No address associated with hostname |  |  |  |
