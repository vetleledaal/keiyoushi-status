...
| popular_next | `getPopularManga(2)` | success | 21 | I Am the Dengle (`.../c4b9a45b-94d4-47c1-a9aa-c20c4a33a983`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 24 | My Battleship Can Be Upgraded (`.../23ed61c1-57d6-423c-96d6-b27147cf84d0`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 21 | Rebirth of the Urban Immortal Cultivator (`.../2fb493d1-a0f8-449d-a474-318793182662`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | Legend of Star General (`.../1424cfb4-fe65-475c-87fd-42877aa8fc84`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 398 | Chapter 01 (`.../5e374c6c-77da-49c2-8c93-1d76c1b211f3`) |  | 1-10s |
...
| chapters | PASS | 398 chapters |  |  |  |
| chapter dates | PASS | 398 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
