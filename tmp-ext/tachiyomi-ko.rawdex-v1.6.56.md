...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 24 | Lustful Games (`.../lustful-games-b60d532c`) |  | <1s |
| popular_next | `getPopularManga(2)` | success | 24 | Someone Stop Her! (`.../someone-stop-her-raw`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 24 | The Dignity of Desire (`.../the-dignity-of-desire`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 24 | Set Up (Kim Mundo) (`.../set-up-kim-mundo`) |  | 1-10s |
...
| details thumbnail URL | UNUSUAL | Differs from selected listing thumbnail; `https://i0.wp.com/.../Lustful-Games-1.jpg <redacted query values: fit and ssl>` (image/jpeg, 207953 bytes, 720x1008) |  |  |  |
...
| redirects | UNUSUAL | popular: `https://rawdex.net/.../1 <redacted query values: m_orderby>` to `https://rawdex.net/.../manga <redacted query values: m_orderby>` (1 redirects); popular: `https://rawdex.net/.../1 <redacted query values: m_orderby>` to `https://rawdex.net/.../manga <redacted query values: m_orderby>` (1 redirects) |  |  |  |
