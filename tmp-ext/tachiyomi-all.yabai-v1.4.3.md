...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: Failed to fetch tokens. Check if the site is accessible. | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Failed to fetch tokens. Check if the site is accessible. | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Failed to fetch tokens. Check if the site is accessible. |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | Failed to fetch tokens. Check if the site is accessible. |  |  |  |
