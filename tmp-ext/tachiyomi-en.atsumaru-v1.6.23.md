...
| popular_next | `getPopularManga(2)` | success | 40 | Absolute Sword Sense (`.../gqrWt`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 40 | N (`.../fGxY`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 40 | The Youngest Is Trying To Prevent the World From Ending (`.../Wx1Y`) |  | <1s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | Witch Hat Atelier (`.../2VgNt`) |  | <1s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Witch Hat Atelier (`.../2VgNt`) |  | 1-10s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 350 | Chapter 0 (`.../0S_52R`) |  | 1-10s |
...
| redirects | UNUSUAL | popular: `https://atsu.moe/.../2332ceb1f6a43dec.avif` to `https://cdn.atsu.moe/.../2332ceb1f6a43dec.avif` (1 redirects); popular: `https://atsu.moe/.../N3HO30V76uWZV9iG-large.avif` to `https://cdn.atsu.moe/.../N3HO30V76uWZV9iG-large.avif` (1 redirects) |  |  |  |
