...
- Extension: tachiyomi-en.rosesquadscans-v1.4.53
- Input artifact: JAR
...
- Source ID: 5475936177780301452
- Source name: Rose Squad Scans
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: It's necessary to login via WebView to access this source. | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.io.IOException: It's necessary to login via WebView to access this source. | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: It's necessary to login via WebView to access this source. | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: It's necessary to login via WebView to access this source. | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | It's necessary to login via WebView to access this source. |  |  |  |
| latest listing | SKIP | It's necessary to login via WebView to access this source. |  |  |  |
...
| popular pagination | SKIP | It's necessary to login via WebView to access this source. |  |  |  |
| latest pagination | SKIP | It's necessary to login via WebView to access this source. |  |  |  |
