...
- Extension: tachiyomi-ar.duskoryvile-v1.4.1
- Input artifact: JAR
...
- Source ID: 4544396460505163576
- Source name: Duskoryvile
- Source language: ar

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: يرجى تسجيل الدخول من إعدادات الإضافة<br>(Please log in via extension settings) | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: يرجى تسجيل الدخول من إعدادات الإضافة<br>(Please log in via extension settings) | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | يرجى تسجيل الدخول من إعدادات الإضافة<br>(Please log in via extension settings) |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | يرجى تسجيل الدخول من إعدادات الإضافة<br>(Please log in via extension settings) |  |  |  |
