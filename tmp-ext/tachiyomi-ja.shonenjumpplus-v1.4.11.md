...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 99 | 打ち切られ漫画家と同人女 (`.../17107094915405394153`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 53 | 💴 (Volume) アスラの沙汰 1 (`.../17106567263376077117`) |  | 1-10s |
...
| chapter dates | LINT | 4 of 53 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=4 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
