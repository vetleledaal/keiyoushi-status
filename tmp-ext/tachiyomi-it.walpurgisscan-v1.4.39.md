...
- Extension: tachiyomi-it.walpurgisscan-v1.4.39
- Input artifact: JAR
...
- Source ID: 6566957355096372149
- Source name: Walpurgi Scan
- Source language: it

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 503 | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 503 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 503 | RETRY_NOW | HTTP_SERVER_ERROR |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 503 | RETRY_NOW | HTTP_SERVER_ERROR |  |
...
| popular listing | SKIP | HTTP error 503 |  |  |  |
| latest listing | SKIP | HTTP error 503 |  |  |  |
...
| popular pagination | SKIP | HTTP error 503 |  |  |  |
| latest pagination | SKIP | HTTP error 503 |  |  |  |
