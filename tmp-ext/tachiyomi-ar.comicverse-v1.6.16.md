...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 7 | INVINCIBLE (`.../invincible.html`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | success | 20 | BEN 10 2026 (`.../ben-10-2026.html`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 20 | ABSOLUTE FLASH (`.../absolute-flash.html`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | INVINCIBLE (`.../invincible.html`) |  | <1s |
