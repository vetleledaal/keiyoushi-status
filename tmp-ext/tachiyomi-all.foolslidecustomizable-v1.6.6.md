...
- Extension: tachiyomi-all.foolslidecustomizable-v1.6.6
- Input artifact: JAR
...
- Source ID: 6351052922295965587
- Source name: FoolSlide Customizable
- Source language: other

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.net.ConnectException: Connection refused | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.net.ConnectException: Connection refused | <1s |
