...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 24 | Supervisor Access (`.../supervisor-access`) |  | 1-10s |
| popular_next | `fetchPopularManga(2)` | success | 24 | Workplace Relationship Management (`.../workplace-relationship-management`) |  | 1-10s |
| latest | `fetchLatestUpdates(1)` | success | 24 | A Visit to Hell (`.../a-visit-to-hell`) |  | 1-10s |
...
| chapter dates | LINT | 114 of 137 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=114 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
