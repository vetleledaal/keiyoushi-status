...
- Extension: tachiyomi-pt.rfdragonscan-v1.4.13
- Input artifact: JAR
...
- Source ID: 3492404357721425345
- Source name: RF Dragon Scan
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: Configure seu email e senha nas configurações da extensão para acessar capítulos restritos. | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Configure seu email e senha nas configurações da extensão para acessar capítulos restritos. | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Configure seu email e senha nas configurações da extensão para acessar capítulos restritos. |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | Configure seu email e senha nas configurações da extensão para acessar capítulos restritos. |  |  |  |
