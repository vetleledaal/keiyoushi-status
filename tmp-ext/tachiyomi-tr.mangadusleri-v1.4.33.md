...
| popular_next | `fetchPopularManga(2)` | success | 14 | Things That Deserve to Die (`.../things-that-deserve-to-die`) |  | 1-10s |
| latest | `fetchLatestUpdates(1)` | success | 24 | Codename Anastasia (`.../codename-anastasia`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 14 | When Life Gives You Tomatoes (`.../when-life-gives-you-tomatoes`) |  | 1-10s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 1 | Romper con la salvación (`.../romper-con-la-salvaci-n`) |  | <1s |
| details | `fetchMangaDetails(manga)` | success | 1 | Romper con la salvación Türkçe Oku (`.../romper-con-la-salvaci-n`) |  | 1-10s |
| chapters | `fetchChapterList(manga)` | success | 4 | Bölüm 3 (`.../bolum-3`) |  | 1-10s |
