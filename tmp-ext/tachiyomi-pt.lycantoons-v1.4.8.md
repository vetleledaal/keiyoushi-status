...
- Extension: tachiyomi-pt.lycantoons-v1.4.8
- Input artifact: JAR
...
- Source ID: 9117178890425713139
- Source name: Lycan Toons
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: \[WebView\]: Timed out | 10s+ |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.io.IOException: \[WebView\]: Timed out | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: \[WebView\]: Timed out | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: \[WebView\]: Timed out | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | \[WebView\]: Timed out |  |  |  |
| latest listing | SKIP | \[WebView\]: Timed out |  |  |  |
...
| popular pagination | SKIP | \[WebView\]: Timed out |  |  |  |
| latest pagination | SKIP | \[WebView\]: Timed out |  |  |  |
