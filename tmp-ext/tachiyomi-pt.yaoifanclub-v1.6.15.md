...
- Extension: tachiyomi-pt.yaoifanclub-v1.6.15
- Input artifact: JAR
...
- Source ID: 3609380518472019202
- Source name: Yaoi Fan Club
...
| redirects | UNUSUAL | popular: `https://www.yaoifanclub.com` to `https://yaoifanclub.com` (1 redirects); popular: `https://www.yaoifanclub.com/.../Series <redacted query values: alt, orderby, max-results, and start-index>` to `https://yaoifanclub.com/.../Series <redacted query values: alt, orderby, max-results, and start-index>` (1 redirects) |  |  |  |
