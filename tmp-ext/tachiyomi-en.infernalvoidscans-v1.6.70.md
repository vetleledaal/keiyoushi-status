...
- Extension: tachiyomi-en.infernalvoidscans-v1.6.70
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 18 | Questism (`.../questism`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 18 | Get Schooled (`.../true-education`) |  | <1s |
