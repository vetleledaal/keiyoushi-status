...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 3 | Vesta de Cooking (`.../ep0`) |  | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | skipped | 0 |  |  | <1s |
| latest_next | `fetchLatestUpdates(2)` | skipped | 0 |  |  | <1s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 1 | Vesta de Cooking (`.../ep0`) |  | <1s |
| details | `fetchMangaDetails(manga)` | success | 1 | Vesta de Cooking (`.../ep0`) |  | <1s |
| chapters | `fetchChapterList(manga)` | success | 17 | 【Chapter 0】Vesta de Cooking (`.../ep0`) |  | <1s |
...
| redirects | UNUSUAL | chapters: `https://holoearth.com/.../ep0` to `https://holoearth.com/.../ep0` (1 redirects) |  |  |  |
