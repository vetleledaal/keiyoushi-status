...
| latest | `getLatestUpdates(1)` | success | 25 | Buta Kizoku wa Mirai wo Kiri Hiraku you desu (`.../2045`) |  | <1s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 127 | Chapter 1 (`.../chapter-1`) |  | 1-10s |
...
| chapter dates | LINT | 18 of 127 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=18 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
