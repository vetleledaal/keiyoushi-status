...
- Extension: tachiyomi-id.mangatale-v1.6.55
- Input artifact: JAR
...
| popular_next | `getPopularManga(2)` | success | 24 | Nano Machine (`.../%7B%22id%22:34691,%22slug%22:%22nano-machine%22%7D`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 24 | Jui-san no Oshigoto in Isekai (`.../%7B%22id%22:241314,%22slug%22:%22jui-san-no-oshigoto-in-isekai%22%7D`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 24 | Buka MBG di Dunia lain (`.../%7B%22id%22:820692,%22slug%22:%22buka-mbg-di-dunia-lain%22%7D`) |  | 1-10s |
...
| thumbnail | PASS | `https://08.ikiru.wtf/.../the-man-cover-550550-ZRf2Onzh.png` (image/png, 2276291 bytes, 1440x2074) |  |  |  |
| details identity | PASS | Details preserved selected URL `{"id":185031,"slug":"the-man"}` |  |  |  |
| details thumbnail URL | PASS | `https://08.ikiru.wtf/.../the-man-cover-550550-ZRf2Onzh.png` |  |  |  |
