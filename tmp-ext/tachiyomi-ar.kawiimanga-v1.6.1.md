...
| popular_next | `getPopularManga(2)` | success | 20 | The Male Lead Is Unhealthily Obsessed With My Health (`.../the-male-lead-is-unhealthily-obsessed-with-my-health`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 20 | Celebrity Lady (`.../celebrity-lady`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 20 | Hashtag My First Love (`.../hashtag-my-first-love`) |  | <1s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 27 | الفصل 1 (`.../1`) |  | <1s |
