...
- Extension: tachiyomi-ja.sokuyomi-v1.4.1
- Input artifact: JAR
...
- Source ID: 3115293328774708452
- Source name: Sokuyomi
- Source language: ja

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 405 | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 405 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 405 | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 405 | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | HTTP error 405 |  |  |  |
| latest listing | SKIP | HTTP error 405 |  |  |  |
...
| popular pagination | SKIP | HTTP error 405 |  |  |  |
| latest pagination | SKIP | HTTP error 405 |  |  |  |
