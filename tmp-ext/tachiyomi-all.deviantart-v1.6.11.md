...
- Extension: tachiyomi-all.deviantart-v1.6.11
- Input artifact: JAR
...
- Source ID: 5211324870873630158
- Source name: DeviantArt
- Source language: all

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.lang.UnsupportedOperationException: Please enter a query in the format of gallery:{username} or gallery:{username}.../%7BfolderId%7D | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.lang.UnsupportedOperationException: Please enter a query in the format of gallery:{username} or gallery:{username}.../%7BfolderId%7D | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Please enter a query in the format of gallery:{username} or gallery:{username}.../%7BfolderId%7D |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | Please enter a query in the format of gallery:{username} or gallery:{username}.../%7BfolderId%7D |  |  |  |
