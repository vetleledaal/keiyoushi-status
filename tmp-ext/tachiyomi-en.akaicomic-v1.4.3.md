...
- Extension: tachiyomi-en.akaicomic-v1.4.3
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: akaicomic.org
...
- Source ID: 1987646205658282178
- Source name: Akai Comic
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: akaicomic.org: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: akaicomic.org | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: akaicomic.org: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: akaicomic.org |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: akaicomic.org | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: akaicomic.org |
...
| popular listing | SKIP | akaicomic.org: No address associated with hostname |  |  |  |
| latest listing | SKIP | akaicomic.org |  |  |  |
...
| popular pagination | SKIP | akaicomic.org: No address associated with hostname |  |  |  |
| latest pagination | SKIP | akaicomic.org |  |  |  |
