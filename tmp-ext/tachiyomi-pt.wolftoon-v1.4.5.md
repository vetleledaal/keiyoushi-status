...
- Extension: tachiyomi-pt.wolftoon-v1.4.5
- Input artifact: JAR
...
- Source ID: 2666797837434784507
- Source name: Wolftoon
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: encmakrlmutvsdzpodov.supabase.co: No address associated with hostname | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: encmakrlmutvsdzpodov.supabase.co | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: encmakrlmutvsdzpodov.supabase.co: No address associated with hostname | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: encmakrlmutvsdzpodov.supabase.co | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | encmakrlmutvsdzpodov.supabase.co: No address associated with hostname |  |  |  |
| latest listing | SKIP | encmakrlmutvsdzpodov.supabase.co |  |  |  |
...
| popular pagination | SKIP | encmakrlmutvsdzpodov.supabase.co: No address associated with hostname |  |  |  |
| latest pagination | SKIP | encmakrlmutvsdzpodov.supabase.co |  |  |  |
