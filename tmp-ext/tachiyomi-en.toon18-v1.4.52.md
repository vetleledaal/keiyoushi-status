...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: toon18.to | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: toon18.to: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: toon18.to | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: toon18.to |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: toon18.to: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: toon18.to |
...
| popular listing | SKIP | toon18.to |  |  |  |
| latest listing | SKIP | toon18.to: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | toon18.to |  |  |  |
| latest pagination | SKIP | toon18.to: No address associated with hostname |  |  |  |
