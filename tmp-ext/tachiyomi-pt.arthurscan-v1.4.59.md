...
- Selected manga input: latest offset 0: I Randomly Have a New Career Every Week (`.../i-randomly-have-a-new-career-every-week-1`)
...
| popular_next | `fetchPopularManga(2)` | success | 8 | Rebirth of the Godly Prodigal (`.../rebirth-of-the-godly-prodigal`) |  | 10s+ |
...
| latest_next | `fetchLatestUpdates(2)` | success | 8 | Ascension to Godhood by Slaying Demons (`.../ascension-to-godhood-by-slaying-demons`) |  | 1-10s |
...
| details | `fetchMangaDetails(manga)` | success | 1 | I Randomly Have a New Career Every Week (`.../i-randomly-have-a-new-career-every-week-1`) |  | 10s+ |
