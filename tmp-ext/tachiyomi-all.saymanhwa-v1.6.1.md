...
| latest | `getLatestUpdates(1)` | success | 24 | Stop Smoking (`.../stop-smoking`) |  | 10s+ |
| latest_next | `getLatestUpdates(2)` | success | 24 | After All Eight Empresses Betrayed Me, I Was Reborn in Regret (`.../after-all-eight-empresses-betrayed-me-i-was-reborn-in-regret`) |  | 1-10s |
...
| details thumbnail URL | PASS | `https://img.saymanhwa.com/.../20260821051400-feaa06c5fe59-thumb-300x420.webp` |  |  |  |
...
| details description | PASS | MILF Hunting In Another World is available in English with 133 chapters. Status: Ongoing. Type: Adult. Genres include Action, Drama, Ecchi, Fantasy. Continue from the chapter list below. |  |  |  |
