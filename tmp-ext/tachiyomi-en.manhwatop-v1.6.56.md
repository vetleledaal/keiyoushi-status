...
| latest | `getLatestUpdates(1)` | success | 25 | Infinite Level Up in Murim (`.../36731`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Holy Emperor’s Grandson Is A Necromancer (`.../79591`) |  | 1-10s |
