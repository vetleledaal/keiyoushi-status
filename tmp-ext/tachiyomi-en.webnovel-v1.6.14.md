...
- Extension: tachiyomi-en.webnovel-v1.6.14
- Input artifact: JAR
...
- Source ID: 4081135203808920563
- Source name: WebNovel
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.io.IOException: Open in WebView to set necessary cookies. | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.io.IOException: Open in WebView to set necessary cookies. | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Open in WebView to set necessary cookies. | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: Open in WebView to set necessary cookies. | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Open in WebView to set necessary cookies. |  |  |  |
| latest listing | SKIP | Open in WebView to set necessary cookies. |  |  |  |
...
| popular pagination | SKIP | Open in WebView to set necessary cookies. |  |  |  |
| latest pagination | SKIP | Open in WebView to set necessary cookies. |  |  |  |
