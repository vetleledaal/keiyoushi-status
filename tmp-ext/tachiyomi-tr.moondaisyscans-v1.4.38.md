...
| latest | `fetchLatestUpdates(1)` | success | 20 | Mission: Save the Hunter [Novel] (`.../mission-save-the-hunter-novel`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 20 | Sign (`.../sign`) |  | 1-10s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 3 | Kiss Me If You Can (`.../kiss-me-if-you-can`) |  | 1-10s |
| details | `fetchMangaDetails(manga)` | success | 1 | Kiss Me If You Can (`.../kiss-me-if-you-can`) |  | 1-10s |
| chapters | `fetchChapterList(manga)` | success | 54 | Bölüm 1 (`.../kiss-me-if-you-can-1-bolum`) |  | 1-10s |
...
| chapter dates | LINT | All 54 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=54 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
