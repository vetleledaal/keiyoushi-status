...
- Extension: tachiyomi-ko.manatoki-v1.4.2
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: manatoki552.net
...
- Source ID: 3581741214949868596
- Source name: Manatoki
- Source language: ko

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: manatoki552.net: No address associated with hostname | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: manatoki552.net | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: manatoki552.net: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manatoki552.net |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: manatoki552.net | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manatoki552.net |
...
| popular listing | SKIP | manatoki552.net: No address associated with hostname |  |  |  |
| latest listing | SKIP | manatoki552.net |  |  |  |
...
| popular pagination | SKIP | manatoki552.net: No address associated with hostname |  |  |  |
| latest pagination | SKIP | manatoki552.net |  |  |  |
