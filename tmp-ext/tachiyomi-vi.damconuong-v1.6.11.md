...
- Extension: tachiyomi-vi.damconuong-v1.6.11
- Input artifact: JAR
...
| popular_next | `getPopularManga(2)` | success | 30 | Vợ Anh Ngon Lắm Đấy! (`.../vo-anh-ngon-lam-day`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 30 | Lời Nguyền Của Kẻ Giả Gái (`.../loi-nguyen-cua-ke-gia-gai`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 30 | Jane Doe (`.../jane-doe`) |  | 1-10s |
