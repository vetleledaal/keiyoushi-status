...
- Source language: tr
- Selected manga input: popular offset 0: Martial Peak (`.../1063`)

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 25 | Martial Peak (`.../1063`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | success | 25 | The Dark Magician Transmigrates After 66666 Years (`.../35`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 25 | Am I the Daughter? (`.../341`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Çirkin bir Leydi Olarak Uyandım (`.../842`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | Martial Peak (`.../1063`) |  | 1-10s |
...
| search listing | PASS | Matched selected manga by URL at result offset 0: title=Martial Peak, URL=`1063` |  |  |  |
...
| thumbnail | PASS | `https://asurascans.com.tr/.../peak-1-350x476.jpg` (image/jpeg, 61062 bytes, 350x476) |  |  |  |
...
| redirects | UNUSUAL | popular: `https://asurascans.com.tr <redacted query values: p>` to `https://asurascans.com.tr/.../martial-peak` (1 redirects); popular: `https://asurascans.com.tr <redacted query values: p>` to `https://asurascans.com.tr/.../martial-peak` (1 redirects) |  |  |  |
