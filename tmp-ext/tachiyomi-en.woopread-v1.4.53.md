...
- Extension: tachiyomi-en.woopread-v1.4.53
- Input artifact: JAR
...
- Source ID: 8919726581572234359
- Source name: WoopRead
- Source language: en
...
| redirects | UNUSUAL | popular: `https://woopread.com/.../manga <redacted query values: m_orderby>` to `https://woopread.com/.../manga <redacted query values: m_orderby>` (1 redirects); latest: `https://woopread.com/.../manga <redacted query values: m_orderby>` to `https://woopread.com/.../manga <redacted query values: m_orderby>` (1 redirects) |  |  |  |
