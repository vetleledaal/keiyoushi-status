...
- Extension: tachiyomi-zh.noyacg-v1.6.7
- Input artifact: JAR
...
- Source ID: 6492346234228542735
- Source name: NoyAcg
- Source language: zh-Hant

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.io.IOException: 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.io.IOException: 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 |  |  |  |
| latest listing | SKIP | 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 |  |  |  |
...
| popular pagination | SKIP | 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 |  |  |  |
| latest pagination | SKIP | 請在擴充套件設定中輸入帳號與密碼，或在 WebView 中登入 |  |  |  |
