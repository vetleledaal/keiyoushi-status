...
- Extension: tachiyomi-pt.hipertoon-v1.6.9
- Input artifact: JAR
...
- Source theme: hiper
- Source ID: 977626289899996655
- Source name: Hipertoon
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 401 | <1s |
