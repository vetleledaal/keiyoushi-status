...
- Extension: tachiyomi-pt.portalyaoi-v1.6.57
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 10 | Painter of the Night (`.../12`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 10 | Honey Trouble (`.../975`) |  | 10s+ |
...
| page load | PASS | `https://portalyaoi.com/.../1.jpg` (image/jpeg, 7007466 bytes, 649x31296) |  |  |  |
