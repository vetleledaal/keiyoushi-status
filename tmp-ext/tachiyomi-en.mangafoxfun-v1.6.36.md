...
| latest_next | `getLatestUpdates(2)` | success | 30 | Momoiro Meloik (`.../momoiro-meloik`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | Onepunch-man (`.../onepunch-man_117`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Onepunch-man (`.../onepunch-man_117`) |  | 1-10s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 293 | Chapter 1 - One Punch (`.../chapter-1.0`) |  | <1s |
...
| chapters | PASS | 293 chapters |  |  |  |
| chapter dates | PASS | 293 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
...
| redirects | UNUSUAL | popular: `https://mangafox.fun/.../chapter-2278` to `https://mangafox.fun/.../martial-peak` (1 redirects) |  |  |  |
