...
- Extension: tachiyomi-pt.lermangas-v1.4.53
- Input artifact: JAR
...
- Source ID: 9215856445653506967
- Source name: Ler Mangas
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 523 | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 523 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 523 | RETRY_NOW | HTTP_SERVER_ERROR |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 523 | RETRY_NOW | HTTP_SERVER_ERROR |  |
...
| popular listing | SKIP | HTTP error 523 |  |  |  |
| latest listing | SKIP | HTTP error 523 |  |  |  |
...
| popular pagination | SKIP | HTTP error 523 |  |  |  |
| latest pagination | SKIP | HTTP error 523 |  |  |  |
