...
- Extension: tachiyomi-es.koinoboriscan-v1.4.40
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: api.visorkoi.com
...
- Source ID: 5873846881094044177
- Source name: Koinobori Scan
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: api.visorkoi.com | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: api.visorkoi.com: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: api.visorkoi.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.visorkoi.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: api.visorkoi.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.visorkoi.com |
...
| popular listing | SKIP | api.visorkoi.com |  |  |  |
| latest listing | SKIP | api.visorkoi.com: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | api.visorkoi.com |  |  |  |
| latest pagination | SKIP | api.visorkoi.com: No address associated with hostname |  |  |  |
