...
- Extension: tachiyomi-en.irovedout-v1.4.5
- Input artifact: JAR
...
- Source ID: 8197175895739916188
- Source name: I Roved Out
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 1 | I Roved Out in Search of Truth and Love (`<redacted URL #1: selected resource; relative; no scheme>`) |  | <1s |
...
| manga title and URL | FAIL | Invalid manga: popular entry 1: title=I Roved Out in Search of Truth and Love, URL=<blank> | DO_NOT_RETRY | DETERMINISTIC_FAILURE |  |
| thumbnail URLs | PASS | 1/1 manga have thumbnail URLs |  |  |  |
| duplicate thumbnail URLs | PASS |  |  |  |  |
| thumbnail | PASS | `https://i.ibb.co/.../irovedout.png` (image/jpeg, 111014 bytes, 550x747) |  |  |  |
