...
| latest | `fetchLatestUpdates(1)` | success | 17 | Becoming Alpha (Uncensored) (`.../becoming-alpha-uncensored`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 16 | Dominion Club (`.../dominion-club`) |  | <1s |
...
| chapters | `fetchChapterList(manga)` | success | 328 | Chapter 1 (`.../chapter-1`) |  | <1s |
