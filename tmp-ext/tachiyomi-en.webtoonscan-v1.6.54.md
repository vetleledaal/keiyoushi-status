...
- Source language: en
- Selected manga input: popular offset 0: Secret Class (`.../1434`)
...
| search listing | PASS | Matched selected manga by URL at result offset 2: title=Secret Class, URL=`1434` |  |  |  |
...
| thumbnail | FAIL | Thumbnail URL `https://webtoonscan.com/.../Secret-Class-1.jpg` could not be downloaded: eu.kanade.tachiyomi.network.HttpException: HTTP error 403 | DO_NOT_RETRY | DETERMINISTIC_FAILURE |  |
