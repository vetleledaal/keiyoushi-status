...
- Extension: tachiyomi-ar.mangatuk-v1.4.52
- Input artifact: JAR
...
- Source ID: 4205255591548488472
- Source name: MangaTuk
- Source language: ar
...
| redirects | UNUSUAL | popular: `https://mangatuk.com/.../manga <redacted query values: m_orderby>` to `https://mangatuk.com/.../browse <redacted query values: m_orderby>` (2 redirects); latest: `https://mangatuk.com/.../manga <redacted query values: m_orderby>` to `https://mangatuk.com/.../browse <redacted query values: m_orderby>` (2 redirects) |  |  |  |
