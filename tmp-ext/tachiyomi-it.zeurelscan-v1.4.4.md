...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 24 | Administrator - Kang Jin Lee (`.../administrator-kang-jin-lee`) |  | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | success | 7 | Primal Hunter (`.../A004`) |  | <1s |
...
| details | `fetchMangaDetails(manga)` | success | 1 | Administrator - Kang Jin Lee (`.../administrator-kang-jin-lee`) |  | <1s |
| chapters | `fetchChapterList(manga)` | success | 140 | Capitolo 1 (`.../1`) |  | <1s |
...
| chapters | PASS | 140 chapters |  |  |  |
| chapter dates | PASS | 140 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
...
| redirects | UNUSUAL | pages: `https://zeurelscan.com/.../Admin_start.jpg` to `https://www.zeurelscan.com/.../Admin_start.jpg` (1 redirects) |  |  |  |
