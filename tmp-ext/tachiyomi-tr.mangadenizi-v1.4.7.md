...
- Extension: tachiyomi-tr.mangadenizi-v1.4.7
- Input artifact: JAR
...
- Source ID: 5186628758186958017
- Source name: MangaDenizi
- Source language: tr

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.NullPointerException | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.NullPointerException | 1-10s |
...
| redirects | UNUSUAL | popular: `https://www.mangadenizi.net/.../manga <redacted query values: sort and page>` to `https://mangadenizi.net/.../manga <redacted query values: sort>` (2 redirects); latest: `https://www.mangadenizi.net/.../manga <redacted query values: page>` to `https://mangadenizi.net/.../manga` (2 redirects) |  |  |  |
