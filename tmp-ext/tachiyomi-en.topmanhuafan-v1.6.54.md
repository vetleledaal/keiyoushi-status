...
- Extension: tachiyomi-en.topmanhuafan-v1.6.54
- Input artifact: JAR
...
- Source theme: madara
- Source ID: 6293890187960663957
- Source name: TopManhua.fan
- Source language: en
- Selected manga input: popular offset 0: Tales of Demons and Gods (`.../6513`)

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 12 | Tales of Demons and Gods (`.../6513`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | success | 12 | Jujutsu Kaisen (`.../7703`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 12 | The Stellar Swordmaster (`.../75380`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 12 | Zombie Herd (`.../64210`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 3 | Tales of Demons and Gods (`.../6513`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Tales of Demons and Gods (`.../6513`) |  | 1-10s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 2128 | Chapter 0 (`.../chapter-0`) |  | <1s |
| pages | `getPageList(chapter)` | success | 161 |  |  | 1-10s |
