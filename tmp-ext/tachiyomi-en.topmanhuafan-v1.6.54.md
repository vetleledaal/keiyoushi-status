...
| popular_next | `getPopularManga(2)` | success | 12 | Jujutsu Kaisen (`.../7703`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 12 | The Count’s Secret Maid (`.../8024`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 12 | I'll never give in! (`.../85839`) |  | <1s |
