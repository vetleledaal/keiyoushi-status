...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 12 | Reincarnated as the Mastermind of the Story: Overcoming Everything with My Ever-Evolving Demon Sword and Game Knowledge (`.../reincarnated-as-the-mastermind-of-the-story-overcoming-everything-with-my-ever-evolving-demon-sword-and-game-knowledge`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | success | 216 | The Shut-In Prince’s Magnificent Society Reformation (`.../the-shut-in-prince-s-magnificent-society-reformation`) |  | 1-10s |
...
| latest listing | PASS | 216 entries |  |  |  |
...
| thumbnail URLs | PASS | 229/229 manga have thumbnail URLs |  |  |  |
