...
- Extension: tachiyomi-fr.hentaiorigines-v1.6.58
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 30 | I Love You Very Much (`.../i-love-you-very-much`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 30 | Set It! (`.../set-it`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 105 | Chapitre 1 Ch.1 (`.../chapitre-1`) |  | <1s |
