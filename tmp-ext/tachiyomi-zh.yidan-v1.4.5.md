...
- Extension: tachiyomi-zh.yidan-v1.4.5
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: yidan9.club
...
- Source ID: 2417676426413230210
- Source name: 一耽女孩
- Source language: zh

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: yidan9.club: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: yidan9.club | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: yidan9.club: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: yidan9.club |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: yidan9.club | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: yidan9.club |
...
| popular listing | SKIP | yidan9.club: No address associated with hostname |  |  |  |
| latest listing | SKIP | yidan9.club |  |  |  |
...
| popular pagination | SKIP | yidan9.club: No address associated with hostname |  |  |  |
| latest pagination | SKIP | yidan9.club |  |  |  |
