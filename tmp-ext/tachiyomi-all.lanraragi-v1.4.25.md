...
- Extension: tachiyomi-all.lanraragi-v1.4.25
- Input artifact: JAR
...
- Source implementation: eu.kanade.tachiyomi.extension.all.lanraragi.LANraragi
- Source ID: 4482480338677079857
- Source name: LANraragi (1)
- Source language: all

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.ConnectException: Connection refused | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.ConnectException: Connection refused | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.ConnectException: Connection refused | RETRY_NOW | TEMPORARY_CONNECTION_FAILURE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.ConnectException: Connection refused | RETRY_NOW | TEMPORARY_CONNECTION_FAILURE |  |
...
| popular listing | SKIP | Connection refused |  |  |  |
| latest listing | SKIP | Connection refused |  |  |  |
...
| popular pagination | SKIP | Connection refused |  |  |  |
| latest pagination | SKIP | Connection refused |  |  |  |
