...
- Extension: tachiyomi-vi.yurigarden-v1.6.11
- Input artifact: JAR
...
- Source ID: 2167942958141879673
- Source name: YuriGarden
- Source language: vi

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.io.IOException: Nguồn này cần đăng nhập bằng webview để xem | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.io.IOException: Nguồn này cần đăng nhập bằng webview để xem | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Nguồn này cần đăng nhập bằng webview để xem | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.io.IOException: Nguồn này cần đăng nhập bằng webview để xem | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Nguồn này cần đăng nhập bằng webview để xem |  |  |  |
| latest listing | SKIP | Nguồn này cần đăng nhập bằng webview để xem |  |  |  |
...
| popular pagination | SKIP | Nguồn này cần đăng nhập bằng webview để xem |  |  |  |
| latest pagination | SKIP | Nguồn này cần đăng nhập bằng webview để xem |  |  |  |
