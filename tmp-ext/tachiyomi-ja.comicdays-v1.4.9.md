...
| latest | `fetchLatestUpdates(1)` | success | 89 | 約10年彼氏いなかったが結婚できるか本気だしてみた　32歳からのマチアプ冒険記 (`.../12207421983943198915`) |  | 1-10s |
...
| details | `fetchMangaDetails(manga)` | success | 1 | 約10年彼氏いなかったが結婚できるか本気だしてみた　32歳からのマチアプ冒険記 (`.../12207421983943198915`) |  | <1s |
| chapters | `fetchChapterList(manga)` | success | 8 | 第１話　ぐいぐいアプローチのシュンスケくん① (`.../12207421983943198915`) |  | 1-10s |
...
| latest listing | PASS | 89 entries |  |  |  |
...
| manga title and URL | PASS | 424/424 listing manga have titles and relative URLs |  |  |  |
