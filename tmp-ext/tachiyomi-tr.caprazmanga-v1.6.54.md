...
- Extension: tachiyomi-tr.caprazmanga-v1.6.54
- Input artifact: JAR
...
- Source ID: 7298383099057828683
- Source name: ÇaprazManga
- Source language: tr

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | 1-10s |
