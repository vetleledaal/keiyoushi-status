...
- Extension: tachiyomi-ko.wolfdotcom-v1.4.4
- Input artifact: JAR
...
- Source ID: 5583626852311652499
- Source name: 늑대닷컴 - 웹툰
- Source language: ko

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.IndexOutOfBoundsException: Index 0 out of bounds for length 0 | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.IndexOutOfBoundsException: Index 0 out of bounds for length 0 | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.lang.IndexOutOfBoundsException: Index 0 out of bounds for length 0 | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.lang.IndexOutOfBoundsException: Index 0 out of bounds for length 0 | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Index 0 out of bounds for length 0 |  |  |  |
| latest listing | SKIP | Index 0 out of bounds for length 0 |  |  |  |
...
| popular pagination | SKIP | Index 0 out of bounds for length 0 |  |  |  |
| latest pagination | SKIP | Index 0 out of bounds for length 0 |  |  |  |
