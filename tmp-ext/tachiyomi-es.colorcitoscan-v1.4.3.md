...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: api.colorcitoscan.com | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: api.colorcitoscan.com: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: api.colorcitoscan.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.colorcitoscan.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: api.colorcitoscan.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.colorcitoscan.com |
...
| popular listing | SKIP | api.colorcitoscan.com |  |  |  |
| latest listing | SKIP | api.colorcitoscan.com: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | api.colorcitoscan.com |  |  |  |
| latest pagination | SKIP | api.colorcitoscan.com: No address associated with hostname |  |  |  |
