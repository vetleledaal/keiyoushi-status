...
- Extension: tachiyomi-es.mangashiina-v1.4.33
- Input artifact: JAR
...
- Source ID: 711368877221654433
- Source name: Manga Mukai
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | <1s |
