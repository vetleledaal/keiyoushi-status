...
- Extension: tachiyomi-en.infinityscans-v1.6.12
- Input artifact: JAR
...
- Source ID: 7769612119788415733
- Source name: InfinityScans
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | keiyoushi.b.w: Timed out waiting for WebView after 15s | 10s+ |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | keiyoushi.b.w: Timed out waiting for WebView after 15s | 10s+ |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | keiyoushi.b.w: Timed out waiting for WebView after 15s | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | keiyoushi.b.w: Timed out waiting for WebView after 15s | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Timed out waiting for WebView after 15s |  |  |  |
| latest listing | SKIP | Timed out waiting for WebView after 15s |  |  |  |
...
| popular pagination | SKIP | Timed out waiting for WebView after 15s |  |  |  |
| latest pagination | SKIP | Timed out waiting for WebView after 15s |  |  |  |
