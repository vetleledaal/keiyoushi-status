...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 10 | Cruzando los muros del amor contigo (`.../kimi-to-koete-koi-ni-naru`) |  | <1s |
...
| chapters | `fetchChapterList(manga)` | success | 31 | Capítulo Personajes (`.../tokage-no-ryoushu-sama-personajes`) |  | 1-10s |
...
| details genres | PASS | +18, Acción, Novela, Smut, Sobrenatural |  |  |  |
