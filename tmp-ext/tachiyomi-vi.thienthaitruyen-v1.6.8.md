...
- Extension: tachiyomi-vi.thienthaitruyen-v1.6.8
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 25 | Tôi Đã Trở Thành Quản Lý Của Clb Bơi Lội Harem Ngực Bự! (`.../toi-da-tro-thanh-quan-ly-cua-clb-boi-loi-harem-nguc-bu`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Mỗi Ngày Đều Mong Chờ Bị Quản Lý Mắng (`.../moi-ngay-deu-mong-cho-bi-quan-ly-mang`) |  | 1-10s |
...
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Anh Người Yêu Có Sở Thích Sex Đặc Biệt (`.../anh-nguoi-yeu-co-so-thich-sex-dac-biet`) |  | <1s |
