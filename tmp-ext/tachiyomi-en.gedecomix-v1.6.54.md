...
| latest | `getLatestUpdates(1)` | success | 25 | Deep Lessons [WKart] (`.../34177`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | A Mother’s Plan (Danny Phantom) (`.../35130`) |  | 1-10s |
