...
- Extension: tachiyomi-en.patchfriday-v1.4.2
- Input artifact: JAR
...
- Source ID: 5782663927698937256
- Source name: Patch Friday
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 1 | Patch Friday (`<redacted URL #1: selected resource; relative; no scheme>`) |  | <1s |
...
| manga title and URL | FAIL | Invalid manga: popular entry 1: title=Patch Friday, URL=<blank> | DO_NOT_RETRY | DETERMINISTIC_FAILURE |  |
| thumbnail URLs | PASS | 1/1 manga have thumbnail URLs |  |  |  |
| duplicate thumbnail URLs | PASS |  |  |  |  |
| thumbnail | PASS | `https://patchfriday.com/.../68.png` (image/png, 733676 bytes, 2000x2120) |  |  |  |
