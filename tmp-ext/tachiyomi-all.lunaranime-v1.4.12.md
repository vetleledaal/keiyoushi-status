...
- Extension: tachiyomi-all.lunaranime-v1.4.12
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: api.lunaranime.ru
...
- Source ID: 7328677245254276970
- Source name: Lunar Manga
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: api.lunaranime.ru: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: api.lunaranime.ru | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: api.lunaranime.ru: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.lunaranime.ru |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: api.lunaranime.ru | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.lunaranime.ru |
...
| popular listing | SKIP | api.lunaranime.ru: No address associated with hostname |  |  |  |
| latest listing | SKIP | api.lunaranime.ru |  |  |  |
...
| popular pagination | SKIP | api.lunaranime.ru: No address associated with hostname |  |  |  |
| latest pagination | SKIP | api.lunaranime.ru |  |  |  |
