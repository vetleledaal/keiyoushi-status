...
- Extension: tachiyomi-en.fairyscans-v1.4.34
- Input artifact: JAR
...
- Source ID: 7842496605600859779
- Source name: Fairy Scans
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.Exception: Could not find required nonces for filtering | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.Exception: Could not find required nonces for filtering | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.lang.Exception: Could not find required nonces for filtering | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.lang.Exception: Could not find required nonces for filtering | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Could not find required nonces for filtering |  |  |  |
| latest listing | SKIP | Could not find required nonces for filtering |  |  |  |
...
| popular pagination | SKIP | Could not find required nonces for filtering |  |  |  |
| latest pagination | SKIP | Could not find required nonces for filtering |  |  |  |
