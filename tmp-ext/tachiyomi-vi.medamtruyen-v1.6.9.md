...
- Extension: tachiyomi-vi.medamtruyen-v1.6.9
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 24 | Mơ Ước Em (`.../mo-uoc-em`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 125 | Chap 0: Giới Thiệu (`.../treu-nham-chap-0`) |  | <1s |
