...
| latest | `fetchLatestUpdates(1)` | success | 20 | Super Gene (`.../super-gene`) |  | <1s |
| latest_next | `fetchLatestUpdates(2)` | success | 20 | The Knight King Who Returned with a God (`.../the-knight-king-who-returned-with-a-god`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 2127 | Chapter 0 (`.../chapter-0`) |  | 10s+ |
...
| latest pagination | UNUSUAL | Overlapping manga: title=The Count’s Secret Maid, URL=`.../the-counts-secret-maid` at page 1 offset 13 and page 2 offset 17, title=Mizuki-senpai's Love Fortune-Telling, URL=`.../mizuki-senpais-love-fortune-tellingg` at page 1 offset 14 and page 2 offset 18, title=The Master of Fate, URL=`.../the-master-of-fate` at page 1 offset 15 and page 2 offset 19 |  |  |  |
