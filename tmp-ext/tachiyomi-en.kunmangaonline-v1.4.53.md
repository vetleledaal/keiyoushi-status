...
- Extension: tachiyomi-en.kunmangaonline-v1.4.53
- Input artifact: JAR
...
- Source ID: 7947062020376654174
- Source name: Kun Manga Online
- Source language: en
- Selected manga input: popular offset 0: Tales of Demons and Gods (`.../tales-of-demons-and-gods`)

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 12 | Tales of Demons and Gods (`.../tales-of-demons-and-gods`) |  | <1s |
| popular_next | `fetchPopularManga(2)` | success | 12 | Jujutsu Kaisen (`.../jujutsu-kaisen`) |  | 1-10s |
| latest | `fetchLatestUpdates(1)` | success | 20 | I Wish My Husband Were Dead (`.../i-wish-my-husband-were-dead`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 20 | Side Character and Popular Guy (`.../side-character-and-popular-guy`) |  | 1-10s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 3 | Tales of Demons and Gods (`.../tales-of-demons-and-gods`) |  | 1-10s |
| details | `fetchMangaDetails(manga)` | success | 1 | Tales of Demons and Gods (`.../tales-of-demons-and-gods`) |  | 1-10s |
| chapters | `fetchChapterList(manga)` | success | 2128 | Chapter 0 (`.../chapter-0`) |  | 10s+ |
