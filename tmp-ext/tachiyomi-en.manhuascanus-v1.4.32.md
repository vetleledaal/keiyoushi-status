...
- Extension: tachiyomi-en.manhuascanus-v1.4.32
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: manhuascan.us
...
- Source ID: 6542792852936422236
- Source name: Manhuascan.us
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: manhuascan.us | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: manhuascan.us: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: manhuascan.us | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manhuascan.us |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: manhuascan.us: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: manhuascan.us |
...
| popular listing | SKIP | manhuascan.us |  |  |  |
| latest listing | SKIP | manhuascan.us: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | manhuascan.us |  |  |  |
| latest pagination | SKIP | manhuascan.us: No address associated with hostname |  |  |  |
