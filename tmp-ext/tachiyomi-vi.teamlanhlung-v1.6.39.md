...
- Extension: tachiyomi-vi.teamlanhlung-v1.6.39
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 32 | VỤNG TRỘM VỚI SẾP CỦA CHỒNG (`.../vung-trom-voi-sep-cua-chong`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 32 | Tự Dưng Bị Bạo Chúa Chấm Làm Con Dâu (`.../tu-dung-bi-bao-chua-cham-lam-con-dau`) |  | <1s |
...
| page load | PASS | `https://cdn.lanhlungteam3.top/.../fcd5b84322aa2039135bd26cdad0d245.jpg` (image/jpeg, 75723 bytes, 884x496) |  |  |  |
