...
| popular_next | `fetchPopularManga(2)` | success | 20 | LADY BOUTIQUE 26年10月号 (`.../show.php <redacted query values: a>`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 1 | 杂志同款怎么买？ (`.../show.php <redacted query values: a>`) |  | <1s |
