...
- Extension: tachiyomi-vi.nhentaiclub-v1.6.4
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: vvcz.online
...
- Source ID: 9124366814387777661
- Source name: NhentaiClub
- Source language: vi

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: vvcz.online: No address associated with hostname | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: vvcz.online | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: vvcz.online: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: vvcz.online |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: vvcz.online | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: vvcz.online |
...
| popular listing | SKIP | vvcz.online: No address associated with hostname |  |  |  |
| latest listing | SKIP | vvcz.online |  |  |  |
...
| popular pagination | SKIP | vvcz.online: No address associated with hostname |  |  |  |
| latest pagination | SKIP | vvcz.online |  |  |  |
