...
| latest | `getLatestUpdates(1)` | success | 25 | The Secret Of Fragrance (`.../29616`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | A Tree without roots (`.../25103`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | Jinx (`.../25077`) |  | 1-10s |
