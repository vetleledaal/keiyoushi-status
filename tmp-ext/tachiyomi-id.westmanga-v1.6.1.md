...
- Extension: tachiyomi-id.westmanga-v1.6.1
- Input artifact: JAR
...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 20 | Yuusha Party wo Kubi ni Natta node Kokyou ni Kaettara, Member Zenin ga Tsuitekitandaga (`.../yuusha-party-wo-kubi-ni-natta-node-kokyou-ni-kaettara-member-zenin-ga-tsuitekitandaga`) |  | <1s |
| popular_next | `getPopularManga(2)` | success | 20 | I Killed An Academy Player (`.../i-killed-an-academy-player`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 20 | Mankitsu Shitai Jouren-san (`.../mankitsu-shitai-jouren-san`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 20 | Filter-Goshi no Kanojo (`.../filter-goshi-no-kanojo`) |  | <1s |
| search | `getSearchManga(1, query, getFilterList())` | success | 20 | Yuusha Party wo Kubi ni Natta node Kokyou ni Kaettara, Member Zenin ga Tsuitekitandaga (`.../yuusha-party-wo-kubi-ni-natta-node-kokyou-ni-kaettara-member-zenin-ga-tsuitekitandaga`) |  | <1s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Yuusha Party wo Kubi ni Natta node Kokyou ni Kaettara, Member Zenin ga Tsuitekitandaga (`.../yuusha-party-wo-kubi-ni-natta-node-kokyou-ni-kaettara-member-zenin-ga-tsuitekitandaga`) |  | <1s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 21 | Chapter 01 (`.../yuusha-party-wo-kubi-ni-natta-node-kokyou-ni-kaettara-member-zenin-ga-tsuitekitandaga-chapter-01-bahasa-indonesia`) |  | <1s |
