...
- Extension: tachiyomi-en.infinityscans-v1.6.13
- Input artifact: JAR
...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | keiyoushi.b.s: Timed out waiting for WebView after 15s | 10s+ |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | keiyoushi.b.s: Timed out waiting for WebView after 15s | 10s+ |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | keiyoushi.b.s: Timed out waiting for WebView after 15s | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | keiyoushi.b.s: Timed out waiting for WebView after 15s | REVIEW | INSUFFICIENT_EVIDENCE |  |
