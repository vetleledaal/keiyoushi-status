...
| latest | `getLatestUpdates(1)` | success | 36 | Close up! Stories after dating (`.../close-up-stories-after-dating`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 36 | Naked Camera (`.../naked-camera`) |  | 1-10s |
...
| redirects | UNUSUAL | popular: `https://aovheroes.com/.../rdsd <redacted query values: data>` to `https://summonersky.com/.../rdsd <redacted query values: data>` (1 redirects) |  |  |  |
| page load | PASS | `https://2.bp.blogspot.com/.../AJQWtBMlAWLYuMV4bli8JMUg8TQfr9ZPUF2UyMw3xNlbIBCXDUSCR7nAgATI4Niu3o1Z9NyhESzTfyIfTCXbzeAIYWNHu-69GyIRMsbsQGcrHrjs2ollcw=w700` (image/jpeg, 97431 bytes, 700x1127) |  |  |  |
