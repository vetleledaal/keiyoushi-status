...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | okhttp3.internal.http2.StreamResetException: stream was reset: PROTOCOL_ERROR | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | okhttp3.internal.http2.StreamResetException: stream was reset: PROTOCOL_ERROR | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | stream was reset: PROTOCOL_ERROR |  |  |  |
| latest listing | SKIP | stream was reset: PROTOCOL_ERROR |  |  |  |
...
| popular pagination | SKIP | stream was reset: PROTOCOL_ERROR |  |  |  |
| latest pagination | SKIP | stream was reset: PROTOCOL_ERROR |  |  |  |
