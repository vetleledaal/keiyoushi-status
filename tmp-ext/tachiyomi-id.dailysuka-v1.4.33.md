...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: dailysuka.com | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: dailysuka.com: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: dailysuka.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: dailysuka.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: dailysuka.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: dailysuka.com |
...
| popular listing | SKIP | dailysuka.com |  |  |  |
| latest listing | SKIP | dailysuka.com: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | dailysuka.com |  |  |  |
| latest pagination | SKIP | dailysuka.com: No address associated with hostname |  |  |  |
