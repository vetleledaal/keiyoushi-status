...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 20 | Lời tỏ tình mạnh mẽ (`.../loi-to-tinh-manh-me`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | success | 18 | Di Nguyện Của Tôi Không Phải Như Thế (`.../di-nguyen-cua-toi-khong-phai-nhu-the`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 20 | Tiểu sư muội không muốn phi thăng (`.../tieu-su-muoi-khong-muon-phi-thang`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 20 | Ác Nữ Chiếm Trọn Trái Tim Đại Công Tước (`.../ac-nu-chiem-tron-trai-tim-ai-cong-tuoc`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 62 | Chapter 1 (`.../1`) |  | <1s |
