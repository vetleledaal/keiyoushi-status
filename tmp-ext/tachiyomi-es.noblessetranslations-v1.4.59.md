...
| popular_next | `fetchPopularManga(2)` | success | 0 |  |  | <1s |
...
| redirects | UNUSUAL | popular: `https://nobledicion.yoveo.xyz/.../admin-ajax.php` to `https://cloudflare-protect.net` (1 redirects); popular_next: `https://nobledicion.yoveo.xyz/.../admin-ajax.php` to `https://cloudflare-protect.net` (1 redirects); latest: `https://nobledicion.yoveo.xyz/.../admin-ajax.php` to `https://cloudflare-protect.net` (1 redirects); latest_next: `https://nobledicion.yoveo.xyz/.../admin-ajax.php` to `https://cloudflare-protect.net` (1 redirects) |  |  |  |
