...
- Extension: tachiyomi-ja.bookwalkerjp-v1.6.3
- Input artifact: JAR
...
| popular_next | `getPopularManga(2)` | success | 60 | ふかふかダンジョン攻略記 ～俺の異世界転生冒険譚～（ブレイドコミックス） (`.../239479`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 60 | サザエさん（朝日新聞出版） (`.../594856`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 60 | サチのお寺ごはん（A.L.C. DX） (`.../55792`) |  | 1-10s |
