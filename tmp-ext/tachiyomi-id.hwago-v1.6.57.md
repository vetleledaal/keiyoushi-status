...
| popular_next | `getPopularManga(2)` | success | 25 | The Annex Lights Never Go Out [ARTEMIS] (`.../the-annex-lights-never-go-out-artemis`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 25 | I’m a Worthless Stepmother, But I Love My Family Madly! (`.../im-a-worthless-stepmother-but-i-love-my-family-madly`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Classmate (2025) (`.../classmate-2025`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | Beasts That Cross the Line (`.../beasts-that-cross-the-line`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Beasts That Cross the Line (`.../beasts-that-cross-the-line`) |  | 1-10s |
...
| popular pagination | UNUSUAL | Overlapping manga: title=Tales of Demons and Gods, URL=`honeypot-trap-xz9k2` at page 1 offset 24 and page 2 offset 24 |  |  |  |
