...
- Extension: tachiyomi-es.insanosscan-v1.4.31
- Input artifact: JAR
...
- Source ID: 5322003068520429479
- Source name: InsanosScan
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | javax.net.ssl.SSLException: (internal_error) Received fatal alert: internal_error | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | (internal_error) Received fatal alert: internal_error |  |  |  |
| latest listing | SKIP | (internal_error) Received fatal alert: internal_error |  |  |  |
...
| popular pagination | SKIP | (internal_error) Received fatal alert: internal_error |  |  |  |
| latest pagination | SKIP | (internal_error) Received fatal alert: internal_error |  |  |  |
