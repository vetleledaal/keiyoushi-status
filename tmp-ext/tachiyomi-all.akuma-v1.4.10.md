...
- Extension: tachiyomi-all.akuma-v1.4.10
- Input artifact: JAR
...
- Source ID: 8524619729907384865
- Source name: Akuma
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: Unable to find CSRF token | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Unable to find CSRF token | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Unable to find CSRF token |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | Unable to find CSRF token |  |  |  |
