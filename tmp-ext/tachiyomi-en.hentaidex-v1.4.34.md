...
- Extension: tachiyomi-en.hentaidex-v1.4.34
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: dexhentai.com
...
- Source ID: 948056929092229440
- Source name: HentaiDex
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: dexhentai.com: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: dexhentai.com | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: dexhentai.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: dexhentai.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: dexhentai.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: dexhentai.com |
...
| popular listing | SKIP | dexhentai.com: No address associated with hostname |  |  |  |
| latest listing | SKIP | dexhentai.com |  |  |  |
...
| popular pagination | SKIP | dexhentai.com: No address associated with hostname |  |  |  |
| latest pagination | SKIP | dexhentai.com |  |  |  |
