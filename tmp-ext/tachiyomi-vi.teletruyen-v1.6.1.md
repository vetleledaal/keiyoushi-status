...
| latest | `getLatestUpdates(1)` | success | 20 | Làm Chuyện Dâm Đãng Với Tôi Không V2? (`.../lam-chuyen-dam-dang-voi-toi-khong-v2`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 20 | Cách Hiệp Sĩ Sống Như Một Tiểu Thư Quyền Quý (`.../cach-hiep-si-song-nhu-mot-tieu-thu-quyen-quy`) |  | 1-10s |
...
| duplicate thumbnail URLs | UNUSUAL | Thumbnail URLs used by different manga URLs: `https://teletruyen.com/.../truyen-moi-cap-nhat <redacted query values: page>` -> 7 manga URLs (examples: `.../lam-chuyen-dam-dang-voi-toi-khong-v2`, `.../ghep-doi-thoat-tim`, `.../song-cung-co-giao`) |  |  |  |
