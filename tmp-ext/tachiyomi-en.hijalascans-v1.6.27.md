...
| latest | `getLatestUpdates(1)` | success | 18 | The Greatest Magician (`.../the-greatest-magician`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 18 | Dream Team Entry (`.../dream-team-entry`) |  | <1s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 56 | Chapter 0 - FogLand  (`.../chapter-0`) |  | <1s |
...
| metadata trimming | LINT | Untrimmed fields: chapter 42 name, chapter 56 name |  |  |  |
