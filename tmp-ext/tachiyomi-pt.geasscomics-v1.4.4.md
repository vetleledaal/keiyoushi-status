...
- Extension: tachiyomi-pt.geasscomics-v1.4.4
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: api.skkyscan.fun
...
- Source ID: 7839519253265657488
- Source name: Geass Comics
- Source language: pt-BR

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: api.skkyscan.fun | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: api.skkyscan.fun: No address associated with hostname | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: api.skkyscan.fun | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.skkyscan.fun |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: api.skkyscan.fun: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: api.skkyscan.fun |
...
| popular listing | SKIP | api.skkyscan.fun |  |  |  |
| latest listing | SKIP | api.skkyscan.fun: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | api.skkyscan.fun |  |  |  |
| latest pagination | SKIP | api.skkyscan.fun: No address associated with hostname |  |  |  |
