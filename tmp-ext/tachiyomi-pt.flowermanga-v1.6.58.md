...
- Selected manga input: latest offset 0: #MeuPrimeiroAmor (`.../5239`)

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 25 | Lágrimas Sobre Flores Murchas (`.../26`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | success | 25 | Uma Princesa que Lê a Sorte (`.../3893`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 25 | #MeuPrimeiroAmor (`.../5239`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | Uma Criança Com Talentos Ocultos Busca Seu Pai (`.../4092`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | #MeuPrimeiroAmor (`.../5239`) |  | 1-10s |
...
| search listing | PASS | Matched selected manga by URL at result offset 0: title=#MeuPrimeiroAmor, URL=`5239` |  |  |  |
...
| thumbnail | PASS | `https://flowermangas.net/.../meuprimeiroamor-5239-350x476.webp` (image/jpeg, 29053 bytes, 350x476; server Content-Type: image/webp) |  |  |  |
