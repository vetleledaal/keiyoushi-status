...
- Extension: tachiyomi-en.mangagofun-v1.4.52
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: www.mangago.fun
...
- Source ID: 6389620462589488124
- Source name: MangaGo.fun
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: www.mangago.fun: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: www.mangago.fun | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: www.mangago.fun: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: www.mangago.fun |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: www.mangago.fun | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: www.mangago.fun |
...
| popular listing | SKIP | www.mangago.fun: No address associated with hostname |  |  |  |
| latest listing | SKIP | www.mangago.fun |  |  |  |
...
| popular pagination | SKIP | www.mangago.fun: No address associated with hostname |  |  |  |
| latest pagination | SKIP | www.mangago.fun |  |  |  |
