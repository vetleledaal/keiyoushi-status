...
- Extension: tachiyomi-all.komga-v1.6.69
- Input artifact: JAR
...
- Source implementation: eu.kanade.tachiyomi.extension.all.komga.Komga
- Source ID: 4508733312114627536
- Source name: Komga
- Source language: all

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.lang.IllegalArgumentException: Expected URL scheme 'http' or 'https' but no scheme was found for .../v... | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.lang.IllegalArgumentException: Expected URL scheme 'http' or 'https' but no scheme was found for .../v... | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.lang.IllegalArgumentException: Expected URL scheme 'http' or 'https' but no scheme was found for .../v... | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.lang.IllegalArgumentException: Expected URL scheme 'http' or 'https' but no scheme was found for .../v... | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Expected URL scheme 'http' or 'https' but no scheme was found for .../v... |  |  |  |
| latest listing | SKIP | Expected URL scheme 'http' or 'https' but no scheme was found for .../v... |  |  |  |
...
| popular pagination | SKIP | Expected URL scheme 'http' or 'https' but no scheme was found for .../v... |  |  |  |
| latest pagination | SKIP | Expected URL scheme 'http' or 'https' but no scheme was found for .../v... |  |  |  |
