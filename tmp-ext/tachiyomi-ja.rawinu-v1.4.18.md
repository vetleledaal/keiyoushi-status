...
| latest | `fetchLatestUpdates(1)` | success | 20 | IJIME TO KAERU TO MAMA TO FUKUSHUU (`.../manga-ijime-to-kaeru-to-mama-to-fukushuu.html`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 20 | SAIBAI CHEAT DE SAIKYOU SAIEN - E, TADA NO KATEI SAIENDESU KEDO? (`.../manga-saibai-cheat-de-saikyou-saien-e-tada-no-katei-saiendesu-kedo.html`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 192 | Chapter 999 (`.../unir-one-piece-raw-chapter-999.html`) |  | 1-10s |
...
| details thumbnail URL | UNUSUAL | Differs from selected listing thumbnail; `https://s4.ihlv1.xyz/.../5f27876233111_5f27876542e6e.jpg` (image/jpeg, 399444 bytes, 764x1200) |  |  |  |
