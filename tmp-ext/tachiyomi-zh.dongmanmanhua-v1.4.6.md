...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 1308 | 如出一辙的女儿 (`.../list <redacted query values: title_no>`) |  | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | success | 40 | 剑尊归来 (`.../list <redacted query values: title_no>`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | skipped | 0 |  |  | <1s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 1 | 如出一辙的女儿 (`.../episodeList <redacted query values: titleNo>`) |  | <1s |
| details | `fetchMangaDetails(manga)` | success | 1 | 如出一辙的女儿 (`.../list <redacted query values: title_no>`) |  | 1-10s |
...
| popular listing | PASS | 1308 entries |  |  |  |
...
| manga title and URL | PASS | 1349/1349 listing manga have titles and relative URLs |  |  |  |
| thumbnail URLs | PASS | 1349/1349 manga have thumbnail URLs |  |  |  |
