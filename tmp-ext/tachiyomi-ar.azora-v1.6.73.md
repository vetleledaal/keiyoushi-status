...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 18 | Nano machine (`.../nano-machine-s`) |  | 1-10s |
...
| latest | `getLatestUpdates(1)` | success | 17 | Selling Because We Broke Up (`.../selling-because-we-broke-up`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 18 | The Baby Sprout Who Bloomed in the Villain Duke’s Family (`.../the-baby-sprout-who-bloomed-in-the-villain-duke's-family`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | Nano machine (`.../nano-machine-s`) |  | <1s |
