...
| popular_next | `getPopularManga(2)` | success | 25 | The Big Boss Comes Down the Mountain: Starting as a Male Secretary (`.../the-big-boss-comes-down-the-mountain-starting-as-a-male-secretary`) |  | <1s |
| latest | `getLatestUpdates(1)` | success | 25 | Reborn As The Enemy Prince (`.../reborn-as-the-enemy-prince`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 25 | World’s Greatest Senior Disciple (`.../worlds-greatest-senior-disciple`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 2 | All My Alter Egos Are Tycoons (`.../all-my-alter-egos-are-tycoons`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | All My Alter Egos Are Tycoons (`.../all-my-alter-egos-are-tycoons`) |  | 1-10s |
...
| popular pagination | UNUSUAL | Overlapping manga: title=Tower of God Season 3, URL=`honeypot-trap-xz9k2` at page 1 offset 24 and page 2 offset 24 |  |  |  |
| latest pagination | UNUSUAL | Overlapping manga: title=Nano Machine, URL=`honeypot-trap-xz9k2` at page 1 offset 24 and page 2 offset 24 |  |  |  |
