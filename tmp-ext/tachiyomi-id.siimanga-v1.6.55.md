...
| latest | `getLatestUpdates(1)` | success | 25 | A Succubus Wants to Live Ordinarily! (`.../1712`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 25 | The Hashtag is First Love (`.../334`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 117 | Chapter 1 (`.../chapter-1`) |  | <1s |
...
| chapter dates | LINT | 112 of 117 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=112 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
