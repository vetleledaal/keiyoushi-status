...
| redirects | UNUSUAL | popular: `https://ghostscan.xyz/.../admin-ajax.php` to `https://ghostscan.xyz/.../suspendedpage.cgi` (1 redirects); popular: `https://ghostscan.xyz/.../admin-ajax.php` to `https://ghostscan.xyz/.../suspendedpage.cgi` (1 redirects) |  |  |  |
