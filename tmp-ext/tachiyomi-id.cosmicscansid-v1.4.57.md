...
- Extension: tachiyomi-id.cosmicscansid-v1.4.57
- Input artifact: JAR
...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 24 | Lookism (`.../lookism`) |  | 1-10s |
| popular_next | `fetchPopularManga(2)` | success | 24 | Murim Psychopath (`.../murim-psychopath`) |  | <1s |
| latest | `fetchLatestUpdates(1)` | success | 24 | The Heavenly Demon Wants A Quiet Life (`.../the-heavenly-demon-wants-a-quiet-life`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 24 | Father, I Won't Do Anything (`.../father-i-wont-do-anything`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 624 | Chapter 01 (`.../lookism-chapter-01`) |  | 1-10s |
...
| thumbnail URLs | UNUSUAL | 95/97 manga have thumbnail URLs |  |  |  |
...
| chapters | PASS | 624 chapters |  |  |  |
| chapter dates | PASS | 624 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
