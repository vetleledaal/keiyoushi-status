...
| latest | `getLatestUpdates(1)` | success | 12 | I Don't Want to Play Matchmaker! (`.../i-dont-want-to-play-matchmaker`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 12 | Their Obsession Will Ruin Me (`.../their-obsession-will-ruin-me`) |  | <1s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 162 | Chapter 1 (`.../chapter-1`) |  | <1s |
...
| latest pagination | UNUSUAL | Overlapping manga: title=I Don't Want to Play Matchmaker!, URL=`.../i-dont-want-to-play-matchmaker` at page 1 offset 0 and page 2 offset 8, title=My Slave Returned After Ten Years, URL=`.../my-slave-returned-after-ten-years` at page 1 offset 1 and page 2 offset 7, title=Emergency Blind Date, URL=`.../emergency-blind-date` at page 1 offset 2 and page 2 offset 2, title=For Your Perfect Ending, URL=`.../for-your-perfect-ending` at page 1 offset 3 and page 2 offset 5, title=Their Obsession Will Ruin Me, URL=`.../their-obsession-will-ruin-me` at page 1 offset 5 and page 2 offset 0, title=The Perks of Being a Villainess, URL=`.../the-perks-of-being-a-villainess` at page 1 offset 6 and page 2 offset 3, title=I Will Become the Villain’s Poison Detector, URL=`.../i-will-become-the-villains-poison-detector` at page 1 offset 7 and page 2 offset 1, title=The Arrogant Young Lady Learns Love Through a Blood Pact, URL=`.../the-arrogant-young-lady-learns-love-through-a-blood-pact` at page 1 offset 8 and page 2 offset 6, title=The Great Mage Is the Youngest Daughter of the Swordmaster Family, URL=`.../the-great-mage-is-the-youngest-daughter-of-the-swordmaster-family` at page 1 offset 11 and page 2 offset 9 |  |  |  |
...
| metadata trimming | LINT | Untrimmed fields: chapter 40 name, chapter 42 name, chapter 43 name, chapter 44 name, chapter 45 name, chapter 46 name, chapter 47 name, chapter 48 name, chapter 49 name |  |  |  |
| chapters | PASS | 162 chapters |  |  |  |
| chapter dates | PASS | 162 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
