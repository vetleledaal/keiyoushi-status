...
- Extension: tachiyomi-fr.dassouscan-v1.4.51
- Input artifact: JAR
...
- Source ID: 7036720639283559699
- Source name: Dassou Scan
- Source language: fr

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.lang.Exception: Title is empty | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.lang.Exception: Title is empty | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.lang.Exception: Title is empty | REVIEW | INSUFFICIENT_EVIDENCE |  |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.lang.Exception: Title is empty | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Title is empty |  |  |  |
| latest listing | SKIP | Title is empty |  |  |  |
...
| popular pagination | SKIP | Title is empty |  |  |  |
| latest pagination | SKIP | Title is empty |  |  |  |
...
| redirects | UNUSUAL | popular: `https://dassouscan.com <redacted query values: post_type and tri>` to `https://dassouscan.com/.../catalogue` (1 redirects); latest: `https://dassouscan.com <redacted query values: post_type>` to `https://dassouscan.com/.../catalogue` (1 redirects) |  |  |  |
