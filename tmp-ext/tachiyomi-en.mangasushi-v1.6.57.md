...
| latest | `getLatestUpdates(1)` | success | 25 | Lonely Attack on the Different World (`.../1909`) |  | 1-10s |
...
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Lonely Attack on the Different World (`.../1909`) |  | 1-10s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 332 | Chapter 1 (`.../chapter-1`) |  | <1s |
...
| chapters | PASS | 332 chapters |  |  |  |
| chapter dates | LINT | 51 of 332 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=51 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
