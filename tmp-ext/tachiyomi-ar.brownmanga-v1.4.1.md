...
- Extension: tachiyomi-ar.brownmanga-v1.4.1
- Input artifact: JAR
...
- Source ID: 2954767545439802080
- Source name: Brown Manga
- Source language: ar
...
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 530 | 1-10s |
...
| latest operation | ERROR | eu.kanade.tachiyomi.network.HttpException: HTTP error 530 | RETRY_NOW | HTTP_SERVER_ERROR |  |
...
| latest listing | SKIP | HTTP error 530 |  |  |  |
...
| latest pagination | SKIP | HTTP error 530 |  |  |  |
