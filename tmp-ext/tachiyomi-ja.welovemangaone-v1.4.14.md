...
- Source name: Love4u
- Source language: ja
- Selected manga input: latest offset 0: Kamuyomi No Maihito (`.../manga-6389`)

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 20 | Isekai De Tochi O Katte Noujou O Tsukurou - Raw (`.../manga-18`) |  | <1s |
| popular_next | `fetchPopularManga(2)` | success | 20 | My Hero Academia (manga) (`.../manga-1840`) |  | 1-10s |
| latest | `fetchLatestUpdates(1)` | success | 20 | Kamuyomi No Maihito (`.../manga-6389`) |  | <1s |
| latest_next | `fetchLatestUpdates(2)` | success | 20 | F-kyuu Tamer Wa Kazu No Bouryoku E Sekai Wo Ura Kara Shihai Suru (`.../manga-8065`) |  | <1s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 1 | Kamuyomi No Maihito (`.../manga-6389`) |  | <1s |
| details | `fetchMangaDetails(manga)` | success | 1 | Kamuyomi No Maihito (`.../manga-6389`) |  | 1-10s |
| chapters | `fetchChapterList(manga)` | success | 10 | Chapter 1 (`.../wlmr-kamuyomi-no-maihito-chapter-1.html`) |  | <1s |
...
| search listing | PASS | Matched selected manga by URL at result offset 0: title=Kamuyomi No Maihito, URL=`.../manga-6389` |  |  |  |
...
| thumbnail | PASS | `https://s4.ihlv1.xyz/.../kamuyomi-no-maihito_692fda8c67781.jpg` (image/jpeg, 280986 bytes, 320x454) |  |  |  |
| details identity | PASS | Details preserved selected URL `.../manga-6389` |  |  |  |
| details thumbnail URL | PASS | `https://s4.ihlv1.xyz/.../kamuyomi-no-maihito_692fda8c67781.jpg` |  |  |  |
