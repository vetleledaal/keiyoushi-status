...
| redirects | UNUSUAL | popular: `https://www.zazamanga.com/.../manga <redacted query values: m_orderby>` to `https://www.zazamanga.com/.../manga <redacted query values: m_orderby>` (2 redirects); popular: `https://www.zazamanga.com/.../manga <redacted query values: m_orderby>` to `https://www.zazamanga.com/.../manga <redacted query values: m_orderby>` (2 redirects); popular: `https://www.zazamanga.com/.../chapter-0` to `https://www.zazamanga.com/.../chapter-0` (2 redirects) |  |  |  |
