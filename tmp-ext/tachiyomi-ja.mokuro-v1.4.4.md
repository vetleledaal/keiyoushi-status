...
- Extension: tachiyomi-ja.mokuro-v1.4.4
- Input artifact: JAR
...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | kotlinx.serialization.MissingFieldException: Field 'volumes' is required for type with serial name 'eu.kanade.tachiyomi.extension.ja.mokuro.SeriesDto', but it was missing | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | kotlinx.serialization.MissingFieldException: Field 'volumes' is required for type with serial name 'eu.kanade.tachiyomi.extension.ja.mokuro.SeriesDto', but it was missing | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Field 'volumes' is required for type with serial name 'eu.kanade.tachiyomi.extension.ja.mokuro.SeriesDto', but it was missing |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | Field 'volumes' is required for type with serial name 'eu.kanade.tachiyomi.extension.ja.mokuro.SeriesDto', but it was missing |  |  |  |
