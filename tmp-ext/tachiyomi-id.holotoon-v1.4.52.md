...
- Extension: tachiyomi-id.holotoon-v1.4.52
- Input artifact: JAR
...
- Source ID: 3970113862660733375
- Source name: Holotoon
- Source language: id
...
| latest | `fetchLatestUpdates(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 404 | 1-10s |
...
| redirects | UNUSUAL | popular: `https://01.holotoon.site/.../komik <redacted query values: m_orderby>` to `https://holodek.run/.../komik <redacted query values: m_orderby>` (2 redirects); latest: `https://01.holotoon.site/.../komik <redacted query values: m_orderby>` to `https://holodek.run/.../komik <redacted query values: m_orderby>` (2 redirects) |  |  |  |
