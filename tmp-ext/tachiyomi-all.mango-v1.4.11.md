...
- Extension: tachiyomi-all.mango-v1.4.11
- Input artifact: JAR
...
- Source ID: 2882993841250976719
- Source name: Mango
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.io.IOException: Missing username or password | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.io.IOException: Missing username or password | REVIEW | INSUFFICIENT_EVIDENCE |  |
...
| popular listing | SKIP | Missing username or password |  |  |  |
| latest listing | SKIP | supportsLatest = false |  |  |  |
| search listing | SKIP | No manga was returned by popular or latest |  |  |  |
| latest differs from popular | SKIP | supportsLatest = false |  |  |  |
| popular pagination | SKIP | Missing username or password |  |  |  |
