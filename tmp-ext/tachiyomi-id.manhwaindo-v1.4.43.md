...
| latest | `fetchLatestUpdates(1)` | success | 20 | Ticket Hero S2 (`.../ticket-hero-s2`) |  | 1-10s |
| latest_next | `fetchLatestUpdates(2)` | success | 20 | Genius Grandson of the Loan Shark King (`.../genius-grandson-of-the-loan-shark-king`) |  | 1-10s |
...
| chapters | `fetchChapterList(manga)` | success | 621 | Chapter 1 (`.../lookism-chapter-1`) |  | 1-10s |
...
| chapters | PASS | 621 chapters |  |  |  |
| chapter dates | LINT | All 621 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=621 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
