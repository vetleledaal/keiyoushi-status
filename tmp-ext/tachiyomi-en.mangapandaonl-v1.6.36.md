...
| popular_next | `getPopularManga(2)` | success | 30 | Red Storm (`.../red-storm_119`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 30 | Kengan Omega (`.../kengan-omega`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 30 | STAR WARS: Lost Stars (`.../star-wars-lost-stars`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 4 | One Piece (`.../one-piece_122`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | One Piece (`.../one-piece_122`) |  | 1-10s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 1217 | Chapter 1 - Romance Dawn (`.../chapter-1.0`) |  | <1s |
...
| chapters | PASS | 1217 chapters |  |  |  |
| chapter dates | PASS | 1217 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
