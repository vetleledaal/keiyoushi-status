...
- Extension: tachiyomi-ar.mangaspark-v1.4.60
- Input artifact: JAR
...
- Source ID: 2436176998646301840
- Source name: MangaSpark
- Source language: ar
...
| latest_next | `fetchLatestUpdates(2)` | success | 10 | The Former Supreme (`.../the-former-supreme`) |  | 1-10s |
...
| thumbnail | PASS | `https://sparkio.sparkmanga.net/.../Otherworldly-Evil-Monarch-175x238.jpg` (image/jpeg, 15870 bytes, 175x238) |  |  |  |
