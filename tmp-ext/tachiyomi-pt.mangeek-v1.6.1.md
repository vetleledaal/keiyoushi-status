...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 126 | The Return of the Iron-Blood Sword Hound (`.../1687192031`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | success | 12 | ENNEAD (`.../1691793543`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 187 | Capítulo 0.1 (`.../1698212987`) |  | <1s |
...
| popular listing | PASS | 126 entries |  |  |  |
...
| chapter dates | LINT | All 187 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=187 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
