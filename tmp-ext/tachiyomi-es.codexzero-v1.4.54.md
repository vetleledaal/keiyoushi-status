...
- Extension: tachiyomi-es.codexzero-v1.4.54
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: codex.readkisho.me
...
- Source ID: 5416462601349591349
- Source name: Codex Zero
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: codex.readkisho.me | 1-10s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: codex.readkisho.me: No address associated with hostname | 1-10s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: codex.readkisho.me | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: codex.readkisho.me |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: codex.readkisho.me: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: codex.readkisho.me |
...
| popular listing | SKIP | codex.readkisho.me |  |  |  |
| latest listing | SKIP | codex.readkisho.me: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | codex.readkisho.me |  |  |  |
| latest pagination | SKIP | codex.readkisho.me: No address associated with hostname |  |  |  |
