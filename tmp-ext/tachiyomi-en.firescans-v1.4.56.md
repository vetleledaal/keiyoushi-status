...
- Extension: tachiyomi-en.firescans-v1.4.56
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: firescans.xyz
...
- Source ID: 5761461704760730187
- Source name: Firescans
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: firescans.xyz: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: firescans.xyz | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: firescans.xyz: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: firescans.xyz |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: firescans.xyz | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: firescans.xyz |
...
| popular listing | SKIP | firescans.xyz: No address associated with hostname |  |  |  |
| latest listing | SKIP | firescans.xyz |  |  |  |
...
| popular pagination | SKIP | firescans.xyz: No address associated with hostname |  |  |  |
| latest pagination | SKIP | firescans.xyz |  |  |  |
