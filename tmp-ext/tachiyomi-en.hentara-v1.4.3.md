...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | success | 1415 | Teach Me First! (`.../teach-me-first`) |  | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | success | 1415 | Set It (`.../set-it`) |  | 1-10s |
...
| popular listing | PASS | 1415 entries |  |  |  |
| latest listing | PASS | 1415 entries |  |  |  |
...
| manga title and URL | PASS | 2831/2831 listing manga have titles and relative URLs |  |  |  |
| thumbnail URLs | PASS | 2831/2831 manga have thumbnail URLs |  |  |  |
