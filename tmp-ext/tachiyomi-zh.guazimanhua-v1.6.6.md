...
| latest | `getLatestUpdates(1)` | success | 36 | 笨拙心动 (`.../comic.php <redacted query values: id>`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 36 | 和补习部一起学数学 (`.../comic.php <redacted query values: id>`) |  | 1-10s |
