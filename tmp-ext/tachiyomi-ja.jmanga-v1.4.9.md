...
- Extension: tachiyomi-ja.jmanga-v1.4.9
- Input artifact: JAR
...
| thumbnail | FAIL | Thumbnail URL `https://mgoimg.view47.com/.../8adc64ef44d7a8aef751138c50dba870.jpeg` could not be downloaded: eu.kanade.tachiyomi.network.HttpException: HTTP error 403 | DO_NOT_RETRY | DETERMINISTIC_FAILURE |  |
...
| details thumbnail URL | FAIL | Differs from selected listing thumbnail; Thumbnail URL `https://mgoimg.view47.com/.../8adc64ef44d7a8aef751138c50dba870.jpeg` could not be downloaded: eu.kanade.tachiyomi.network.HttpException: HTTP error 403 | DO_NOT_RETRY | DETERMINISTIC_FAILURE |  |
...
| redirects | UNUSUAL | popular: `https://jmanga.email/.../filter <redacted query values: sort and page>` to `https://jmanga.email/.../filter <redacted query values: sort and page>` (1 redirects); popular_next: `https://jmanga.email/.../filter <redacted query values: sort and page>` to `https://jmanga.email/.../filter <redacted query values: sort and page>` (1 redirects); latest: `https://jmanga.email/.../filter <redacted query values: sort and page>` to `https://jmanga.email/.../filter <redacted query values: sort and page>` (1 redirects); latest_next: `https://jmanga.email/.../filter <redacted query values: sort and page>` to `https://jmanga.email/.../filter <redacted query values: sort and page>` (1 redirects) |  |  |  |
