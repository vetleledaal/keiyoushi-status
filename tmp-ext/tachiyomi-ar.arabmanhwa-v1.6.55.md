...
| latest | `getLatestUpdates(1)` | success | 16 | pheromone (`.../4138`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 16 | Reversed Virtues (`.../1950`) |  | <1s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 133 | الفصل 01 (`.../%d8%a7%d9%84%d9%81%d8%b5%d9%84-01`) |  | <1s |
...
| chapter dates | LINT | 11 of 133 chapters lack a usable source upload timestamp: 0 (not provided or parsing failed; host uses a default date)=11 |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
