...
- Extension: tachiyomi-en.mgreadio-v1.6.3
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 24 | I become immortal (`.../i-become-immortal`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 24 | I’m Not That Kind of Talent (`.../im-not-that-kind-of-talent`) |  | <1s |
...
| pages | `getPageList(chapter)` | success | 115 |  |  | <1s |
...
| page load | PASS | `https://mg.mgread.io/.../1.webp` (image/webp (encoding: lossy), 106502 bytes, 800x1500) |  |  |  |
