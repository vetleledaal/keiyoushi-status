...
| popular_next | `getPopularManga(2)` | success | 10 | Bandit King (`.../bandit-king`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 10 | 2 soccer men  (`.../2-soccer-men`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 10 | In His Majesty's Service  (`.../in-his-majestys-service`) |  | 1-10s |
