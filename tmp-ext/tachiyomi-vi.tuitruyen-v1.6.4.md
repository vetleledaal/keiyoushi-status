...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 30 | Iruma Giá Đáo! (`.../4-iruma-gia-dao`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | success | 24 | Iruma Giá Đáo! (`.../4-iruma-gia-dao`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 24 | Fate/Grand Order: Epic Of Remnant - Shinjuku (`.../73-fate-grand-order-epic-of-remnant-shinjuku`) |  | 1-10s |
| search | `getSearchManga(1, query, getFilterList())` | success | 4 | Iruma Giá Đáo! (`.../4-iruma-gia-dao`) |  | 1-10s |
| details | `getMangaUpdate(manga, emptyList(), true, false)` | success | 1 | Iruma Giá Đáo! (`.../4-iruma-gia-dao`) |  | <1s |
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 468 | Ch. 1 (`.../1`) |  | 10s+ |
...
| search listing | PASS | Matched selected manga by URL at result offset 0: title=Iruma Giá Đáo!, URL=`.../4-iruma-gia-dao` |  |  |  |
...
| chapters | PASS | 468 chapters |  |  |  |
| chapter dates | PASS | 468 positive upload dates |  |  |  |
| chapter titles | PASS |  |  |  |  |
| chapter URLs | PASS |  |  |  |  |
