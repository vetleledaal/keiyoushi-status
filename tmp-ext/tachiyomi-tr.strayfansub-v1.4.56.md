...
- Extension: tachiyomi-tr.strayfansub-v1.4.56
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: strayfansub.net
...
- Source ID: 7536061906713738443
- Source name: Stray Fansub
- Source language: tr

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: strayfansub.net | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: strayfansub.net: No address associated with hostname | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: strayfansub.net | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: strayfansub.net |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: strayfansub.net: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: strayfansub.net |
...
| popular listing | SKIP | strayfansub.net |  |  |  |
| latest listing | SKIP | strayfansub.net: No address associated with hostname |  |  |  |
...
| popular pagination | SKIP | strayfansub.net |  |  |  |
| latest pagination | SKIP | strayfansub.net: No address associated with hostname |  |  |  |
