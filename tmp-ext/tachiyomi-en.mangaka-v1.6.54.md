...
- Extension: tachiyomi-en.mangaka-v1.6.54
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: mangaka.cc
...
- Source ID: 3253856465912445981
- Source name: MangaKa
- Source language: en

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: mangaka.cc: No address associated with hostname | <1s |
| popular_next | `getPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `getLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: mangaka.cc | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: mangaka.cc: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: mangaka.cc |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: mangaka.cc | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: mangaka.cc |
...
| popular listing | SKIP | mangaka.cc: No address associated with hostname |  |  |  |
| latest listing | SKIP | mangaka.cc |  |  |  |
...
| popular pagination | SKIP | mangaka.cc: No address associated with hostname |  |  |  |
| latest pagination | SKIP | mangaka.cc |  |  |  |
