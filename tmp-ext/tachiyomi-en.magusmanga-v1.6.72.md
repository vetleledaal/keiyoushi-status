...
- Extension: tachiyomi-en.magusmanga-v1.6.72
- Input artifact: JAR
...
| latest | `getLatestUpdates(1)` | success | 18 | The Top 1 Student Hides Her Regression (`.../the-top-1-student-hides-her-regression`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 18 | Took on the Villain Boss's Request (`.../took-on-the-villain-boss's-request`) |  | <1s |
