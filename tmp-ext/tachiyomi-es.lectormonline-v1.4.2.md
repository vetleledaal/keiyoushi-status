...
- Extension: tachiyomi-es.lectormonline-v1.4.2
- Input artifact: JAR
...
- Retry condition: HOST_RESOLVES: mangolibreria.com
...
- Source ID: 4234224579308349686
- Source name: MangoLibreria
- Source language: es

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: mangolibreria.com: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: mangolibreria.com | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: mangolibreria.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: mangolibreria.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: mangolibreria.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: mangolibreria.com |
...
| popular listing | SKIP | mangolibreria.com: No address associated with hostname |  |  |  |
| latest listing | SKIP | mangolibreria.com |  |  |  |
...
| popular pagination | SKIP | mangolibreria.com: No address associated with hostname |  |  |  |
| latest pagination | SKIP | mangolibreria.com |  |  |  |
