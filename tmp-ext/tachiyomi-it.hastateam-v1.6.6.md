...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 62 | 10th Dimension Boys (`.../10th_dimension_boys`) |  | 1-10s |
...
| search | `getSearchManga(1, query, getFilterList())` | success | 1 | 10th Dimension Boys (`.../10th_dimension_boys`) |  | <1s |
