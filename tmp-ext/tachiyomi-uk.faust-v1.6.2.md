...
| popular_next | `getPopularManga(2)` | success | 12 | До зустрічі, мій королю (`.../do-zustrichi-mii-koroliu`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 12 | Рубіж спокуси (`.../rubizh-spokusy`) |  | <1s |
| latest_next | `getLatestUpdates(2)` | success | 12 | Зайвий у романі (`.../zaivyi-u-romani`) |  | <1s |
