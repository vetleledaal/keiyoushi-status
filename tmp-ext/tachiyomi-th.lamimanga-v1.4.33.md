...
- Extension: tachiyomi-th.lamimanga-v1.4.33
- Input artifact: JAR
...
- Source ID: 13019989243414985
- Source name: Lami-Manga
- Source language: th

| Operation | Method | Result | Entries | Selected manga | Exception | Duration |
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | eu.kanade.tachiyomi.network.HttpException: HTTP error 521 | 1-10s |
