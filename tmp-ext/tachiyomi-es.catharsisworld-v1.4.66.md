...
- Extension: tachiyomi-es.catharsisworld-v1.4.66
- Input artifact: JAR
...
- Source ID: 2856082375563763469
- Source name: Catharsis World
- Source language: es
...
| redirects | UNUSUAL | latest: `https://catharsisworld.dig-it.info/.../admin-ajax.php` to `https://catharsisworld.com/.../admin-ajax.php` (1 redirects); latest: `https://catharsisworld.dig-it.info/.../admin-ajax.php` to `https://catharsisworld.com/.../admin-ajax.php` (1 redirects) |  |  |  |
