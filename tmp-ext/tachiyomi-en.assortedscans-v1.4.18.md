...
| latest | `fetchLatestUpdates(1)` | success | 25 | Kings' Viking (`.../kings-viking`) |  | <1s |
| latest_next | `fetchLatestUpdates(2)` | success | 25 | Pen Pal at the End of the World (`.../penpal`) |  | 1-10s |
| search | `fetchSearchManga(1, query, getFilterList())` | success | 1 | Even a Cat's Paw Can Be Useful (`.../nekotete`) |  | 1-10s |
| details | `fetchMangaDetails(manga)` | success | 1 | Even a Cat's Paw Can Be Useful (`.../nekotete`) |  | 1-10s |
...
| thumbnail | PASS | `https://i3.wp.com/.../cover.jpg <redacted query values: ssl, quality, and fit>` (image/jpeg, 18552 bytes, 300x159) |  |  |  |
...
| page load | PASS | `https://i3.wp.com/.../2ab422e7dcc406add6d25e0fee80ca21.png <redacted query values: ssl>` (image/png, 204943 bytes, 801x1200) |  |  |  |
