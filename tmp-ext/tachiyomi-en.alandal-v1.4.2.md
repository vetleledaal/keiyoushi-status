...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `fetchPopularManga(1)` | error | 0 |  | java.net.UnknownHostException: qq.alandal.com: No address associated with hostname | <1s |
| popular_next | `fetchPopularManga(2)` | skipped | 0 |  |  | <1s |
| latest | `fetchLatestUpdates(1)` | error | 0 |  | java.net.UnknownHostException: qq.alandal.com | <1s |
...
| --- | --- | --- | --- | --- | --- |
| popular operation | ERROR | java.net.UnknownHostException: qq.alandal.com: No address associated with hostname | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: qq.alandal.com |
| popular_next operation | SKIP | hasNextPage = false |  |  |  |
| latest operation | ERROR | java.net.UnknownHostException: qq.alandal.com | RETRY_WHEN | DNS_LOOKUP_FAILURE | HOST_RESOLVES: qq.alandal.com |
...
| popular listing | SKIP | qq.alandal.com: No address associated with hostname |  |  |  |
| latest listing | SKIP | qq.alandal.com |  |  |  |
...
| popular pagination | SKIP | qq.alandal.com: No address associated with hostname |  |  |  |
| latest pagination | SKIP | qq.alandal.com |  |  |  |
