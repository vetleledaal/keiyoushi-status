...
| --- | --- | --- | ---: | --- | --- | ---: |
| popular | `getPopularManga(1)` | success | 20 | The Kid Is Obsessed With Me (`.../184`) |  | 1-10s |
| popular_next | `getPopularManga(2)` | success | 20 | The usefulness of a childhood friend (`.../133`) |  | 1-10s |
| latest | `getLatestUpdates(1)` | success | 20 | Mutlak Sınır (`.../115`) |  | 1-10s |
| latest_next | `getLatestUpdates(2)` | success | 20 | A Fighting Dog’s Way of Courtship (`.../1080`) |  | 1-10s |
...
| chapters | `reuse details chapters or getMangaUpdate(manga, emptyList(), false, true)` | success | 50 | Bölüm 1 (`.../bolum-1`) |  | 1-10s |
...
| page load | FAIL | First page URL `https://s300.melek.mom/.../00.jpg` could not be downloaded: eu.kanade.tachiyomi.network.HttpException: HTTP error 403 | DO_NOT_RETRY | DETERMINISTIC_FAILURE |  |
